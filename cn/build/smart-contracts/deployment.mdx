...
- _Access to a Quai node_: you can do this either by [running your own node](/cn/guides/client/node), [accessing a publicly available node](/cn/build/networks), or through API key via a node service.
...
Information on how to deploy a simple smart contract with hardhat can be found in the [Solidity Deployment Tutorial](/cn/guides/development/solidity).

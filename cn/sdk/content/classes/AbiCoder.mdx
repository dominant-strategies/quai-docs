...
| :------ | :------ | :------ |
| `types` | readonly (`string` \| [`ParamType`](/cn/sdk/content/classes/ParamType))[] | Array of parameter types. |
| `data` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The ABI data to decode. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `types` | readonly (`string` \| [`ParamType`](/cn/sdk/content/classes/ParamType))[] | Array of parameter types to get default values for. |
...
Returns the shared singleton instance of a default [**AbiCoder**](/cn/sdk/content/classes/AbiCoder).
...
Returns a quais-compatible [**CallExceptionError**](/cn/sdk/content/interfaces/CallExceptionError) for the given result data.

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `action` | [`CallExceptionAction`](/cn/sdk/content/type-aliases/CallExceptionAction) | The action that triggered the exception. |
| `tx` | `object` | The transaction information. |
| `tx.data`? | `string` | - |
| `tx.from`? | `null` \| `string` | - |
| `tx.to`? | `null` \| `string` | - |
| `data` | `null` \| [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The data associated with the call exception. |

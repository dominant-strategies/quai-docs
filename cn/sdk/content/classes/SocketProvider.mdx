...
- [`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider)\<[`WebSocketLike`](/cn/sdk/content/interfaces/WebSocketLike)\>
...
| :------ | :------ | :------ |
| `network`? | [`Networkish`](/cn/sdk/content/type-aliases/Networkish) | The network to connect to. |
| `_options`? | [`JsonRpcApiProviderOptions`](/cn/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the provider. |
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`constructor`](/cn/sdk/content/classes/JsonRpcApiProvider#constructors)
...
If this provider has been destroyed using the [**destroy**](/cn/sdk/content/classes/AbstractProvider#destroy) method.
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`_clearTimeout`](/cn/sdk/content/classes/JsonRpcApiProvider#_cleartimeout)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`destroy`](/cn/sdk/content/classes/JsonRpcApiProvider#destroy)
...
`Promise`\<[`Shard`](/cn/sdk/content/enumerations/Shard)[]\>

A promise that resolves to the active shards.

#### Inherited from

[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getActiveRegions`](/cn/sdk/content/classes/JsonRpcApiProvider#getactiveregions)
...
`Promise`\<[`Zone`](/cn/sdk/content/enumerations/Zone)[]\>

A promise that resolves to the active zones.

#### Inherited from

[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getActiveZones`](/cn/sdk/content/classes/JsonRpcApiProvider#getactivezones)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone to get the rate for. |
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getLatestQiToQuaiRate`](/cn/sdk/content/classes/JsonRpcApiProvider#getlatestqitoquairate)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getLatestQuaiToQiRate`](/cn/sdk/content/classes/JsonRpcApiProvider#getlatestquaitoqirate)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getProtocolExpansionNumber`](/cn/sdk/content/classes/JsonRpcApiProvider#getprotocolexpansionnumber)
...
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone to get the rate for. |
| `blockTag` | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The block tag to get the rate at. |
| `amt`? | `bigint` | The amount to get the rate for. Default is `1` |
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getQiToQuaiRateAtBlock`](/cn/sdk/content/classes/JsonRpcApiProvider#getqitoquairateatblock)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getQuaiToQiRateAtBlock`](/cn/sdk/content/classes/JsonRpcApiProvider#getquaitoqirateatblock)
...
`Promise`\<[`JsonRpcSigner`](/cn/sdk/content/classes/JsonRpcSigner)\>

A promise that resolves to the JsonRpcSigner.

#### Inherited from

[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`getSigner`](/cn/sdk/content/classes/JsonRpcApiProvider#getsigner)
...
| :------ | :------ |
| `U` | `string`[] \| [`FetchRequest`](/cn/sdk/content/classes/FetchRequest) |
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`initialize`](/cn/sdk/content/classes/JsonRpcApiProvider#initialize)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`listAccounts`](/cn/sdk/content/classes/JsonRpcApiProvider#listaccounts)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`pause`](/cn/sdk/content/classes/JsonRpcApiProvider#pause)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`resume`](/cn/sdk/content/classes/JsonRpcApiProvider#resume)
...
| `shard`? | [`Shard`](/cn/sdk/content/enumerations/Shard) | The shard to send the request to. |
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`send`](/cn/sdk/content/classes/JsonRpcApiProvider#send)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`shardFromHash`](/cn/sdk/content/classes/JsonRpcApiProvider#shardfromhash)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_address` | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address to get the zone from. |
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`zoneFromAddress`](/cn/sdk/content/classes/JsonRpcApiProvider#zonefromaddress)
...
[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider).[`zoneFromHash`](/cn/sdk/content/classes/JsonRpcApiProvider#zonefromhash)

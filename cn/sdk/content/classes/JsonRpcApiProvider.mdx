...
- [`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider)\<`C`\>
...
| :------ | :------ |
| `C` | [`FetchRequest`](/cn/sdk/content/classes/FetchRequest) |
...
| `options`? | [`JsonRpcApiProviderOptions`](/cn/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the provider. |

#### Returns

[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider)\<`C`\>

#### Overrides

[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`constructor`](/cn/sdk/content/classes/AbstractProvider#constructors)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`_clearTimeout`](/cn/sdk/content/classes/AbstractProvider#_cleartimeout)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`destroy`](/cn/sdk/content/classes/AbstractProvider#destroy)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`getActiveRegions`](/cn/sdk/content/classes/AbstractProvider#getactiveregions)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`getActiveZones`](/cn/sdk/content/classes/AbstractProvider#getactivezones)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`getLatestQiToQuaiRate`](/cn/sdk/content/classes/AbstractProvider#getlatestqitoquairate)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`getLatestQuaiToQiRate`](/cn/sdk/content/classes/AbstractProvider#getlatestquaitoqirate)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`getProtocolExpansionNumber`](/cn/sdk/content/classes/AbstractProvider#getprotocolexpansionnumber)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`getQiToQuaiRateAtBlock`](/cn/sdk/content/classes/AbstractProvider#getqitoquairateatblock)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`getQuaiToQiRateAtBlock`](/cn/sdk/content/classes/AbstractProvider#getquaitoqirateatblock)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`initialize`](/cn/sdk/content/classes/AbstractProvider#initialize)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`pause`](/cn/sdk/content/classes/AbstractProvider#pause)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`resume`](/cn/sdk/content/classes/AbstractProvider#resume)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`shardFromHash`](/cn/sdk/content/classes/AbstractProvider#shardfromhash)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`zoneFromAddress`](/cn/sdk/content/classes/AbstractProvider#zonefromaddress)
...
[`AbstractProvider`](/cn/sdk/content/classes/AbstractProvider).[`zoneFromHash`](/cn/sdk/content/classes/AbstractProvider#zonefromhash)

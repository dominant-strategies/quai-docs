...
- [`AbstractSigner`](/cn/sdk/content/classes/AbstractSigner)\<[`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider)\>
...
| :------ | :------ | :------ |
| `provider` | [`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider)\<`any`\> | The JSON-RPC provider. |
...
[`AbstractSigner`](/cn/sdk/content/classes/AbstractSigner).[`constructor`](/cn/sdk/content/classes/AbstractSigner#constructors)
...
| :------ | :------ | :------ | :------ | :------ |
| `provider` | `readonly` | [`JsonRpcApiProvider`](/cn/sdk/content/classes/JsonRpcApiProvider)\<[`FetchRequest`](/cn/sdk/content/classes/FetchRequest)\> | The provider this signer is connected to. | [`AbstractSigner`](/cn/sdk/content/classes/AbstractSigner).`provider` |
...
[`AbstractSigner`](/cn/sdk/content/classes/AbstractSigner).[`connect`](/cn/sdk/content/classes/AbstractSigner#connect)
...
[`AbstractSigner`](/cn/sdk/content/classes/AbstractSigner).[`getAddress`](/cn/sdk/content/classes/AbstractSigner#getaddress)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction request. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction request. |

...
- Generating addresses for a specific account in any [Zone](/cn/sdk/content/enumerations/Zone)
...
- `AbstractHDWallet`\<[`QiAddressInfo`](/cn/sdk/content/interfaces/QiAddressInfo)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone to aggregate the balance for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `provider` | [`Provider`](/cn/sdk/content/interfaces/Provider) | The provider. |
...
`null` \| [`QiAddressInfo`](/cn/sdk/content/interfaces/QiAddressInfo)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone to get the balance for |
...
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | `undefined` | The zone to get change addresses from |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone`? | [`Zone`](/cn/sdk/content/enumerations/Zone) | Optional zone to filter addresses by |
...
`Promise`\<[`QiAddressInfo`](/cn/sdk/content/interfaces/QiAddressInfo)\>
...
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone in which to retrieve the next change address. |
...
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | `undefined` | - |
| `account` | `number` | `0` | - |
...
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone to get addresses from. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `outpoints` | [`OutpointInfo`](/cn/sdk/content/interfaces/OutpointInfo)[] | The outpoints to import. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone to filter outpoints for. |
...
| `originZone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone where the transaction originates. |
...
| `coinSelectorCreator` | (`utxos`) => [`FewestCoinSelector`](/cn/sdk/content/classes/FewestCoinSelector) \| `ConversionCoinSelector` | - |
...
`Promise`\<[`QiTransaction`](/cn/sdk/content/classes/QiTransaction)\>
...
| Parameter | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | `undefined` | The zone in which to scan for addresses. |
...
| `amount` | `bigint` | The amount of Qi to send. |
| `originZone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone where the transaction originates. |
| `destinationZone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone where the transaction is sent. |
| `options`? | `QiTransactionOptions` | Optional transaction configuration. |
...
| Parameter | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | `undefined` | The zone in which to sync addresses. |
...
| Type parameter |
| :------ |
| `T` *extends* `AbstractHDWallet`\<[`NeuteredAddressInfo`](/cn/sdk/content/interfaces/NeuteredAddressInfo), `T`\> |
...
| `wordlist`? | [`Wordlist`](/cn/sdk/content/classes/Wordlist) | The wordlist. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `serialized` | [`SerializedQiHDWallet`](/cn/sdk/content/interfaces/SerializedQiHDWallet) | The serialized object representing the state of a QiHDWallet. |

#### Returns

`Promise`\<[`QiHDWallet`](/cn/sdk/content/classes/QiHDWallet)\>
...
| :------ | :------ | :------ |
| `this` | `Object` | The constructor of the HD wallet. |
| `mnemonic` | [`Mnemonic`](/cn/sdk/content/classes/Mnemonic) | The mnemonic. |

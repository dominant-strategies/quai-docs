...
`Promise`\<`null` \| [`QiTransactionResponse`](/cn/sdk/content/classes/QiTransactionResponse)\>
...
use [**getTransaction**](/cn/sdk/content/classes/QiTransactionResponse#gettransaction).

...
| `wordlist`? | `null` \| [`Wordlist`](/cn/sdk/content/classes/Wordlist) | The wordlist for the mnemonic. |
...
| `phrase` | `readonly` | `string` | The mnemonic phrase of 12, 15, 18, 21 or 24 words.<br /><br />Use the [**wordlist**](/cn/sdk/content/classes/Mnemonic) `split` method to get the individual words. |
| `wordlist` | `readonly` | [`Wordlist`](/cn/sdk/content/classes/Wordlist) | The wordlist for this mnemonic. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_entropy` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The entropy for the mnemonic. |
| `wordlist`? | `null` \| [`Wordlist`](/cn/sdk/content/classes/Wordlist) | The wordlist for the mnemonic. |
...
The default `password` is the empty string and the default wordlist is the [[**English wordlist**](/cn/sdk/content/classes/LangEn).

...
| :------ | :------ | :------ | :------ |
| `inputs` | `readonly` | readonly [`ParamType`](/cn/sdk/content/classes/ParamType)[] | The inputs for the fragment. |
| `type` | `readonly` | [`FragmentType`](/cn/sdk/content/type-aliases/FragmentType) | The type of the fragment. |

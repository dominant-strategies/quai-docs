...
An **AbstractSigner** includes most of teh functionality required to get a [**Signer**](/cn/sdk/content/interfaces/Signer) working as
...
| :------ | :------ |
| `P` *extends* `null` \| [`Provider`](/cn/sdk/content/interfaces/Provider) | `null` \| [`Provider`](/cn/sdk/content/interfaces/Provider) |
...
[`AbstractSigner`](/cn/sdk/content/classes/AbstractSigner)\<`P`\>
...
[`Signer`](/cn/sdk/content/interfaces/Signer).[`connect`](/cn/sdk/content/interfaces/Signer#connect)
...
[`Signer`](/cn/sdk/content/interfaces/Signer).[`getAddress`](/cn/sdk/content/interfaces/Signer#getaddress)

...
| :------ | :------ |
| `A` *extends* `any`[] | `any`[] |
| `I` | [`BaseContract`](/cn/sdk/content/classes/BaseContract) |
...
| :------ | :------ | :------ |
| `abi` | [`Interface`](/cn/sdk/content/classes/Interface) \| [`InterfaceAbi`](/cn/sdk/content/type-aliases/InterfaceAbi) | `undefined` |
| `bytecode` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) \| \{ `"object"`: `string`; \} | `undefined` |
| `runner`? | `null` \| [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner) | `undefined` |
| `IPFSHash`? | `null` \| `string` | `null` |

#### Returns

[`ContractFactory`](/cn/sdk/content/classes/ContractFactory)\<`A`, `I`\>
...
| `runner` | `readonly` | `null` \| [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner) | The ContractRunner to deploy the Contract as. |
...
| :------ | :------ | :------ |
| `runner` | `null` \| [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner) | The runner to connect to. |
...
`Promise`\<[`BaseContract`](/cn/sdk/content/classes/BaseContract) & \{
  `"deploymentTransaction"`: [`ContractTransactionResponse`](/cn/sdk/content/classes/ContractTransactionResponse);
 \} & `Omit`\<`I`, keyof [`BaseContract`](/cn/sdk/content/classes/BaseContract)\>\>
...
`Promise`\<[`ContractDeployTransaction`](/cn/sdk/content/interfaces/ContractDeployTransaction)\>
...
| :------ | :------ |
| `A` *extends* `any`[] | `any`[] |
| `I` | [`ContractInterface`](/cn/sdk/content/interfaces/ContractInterface) |
...
| `runner`? | [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner) | The runner to connect to. |

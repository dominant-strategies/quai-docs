...
Returns a new identical [**Signature**](/cn/sdk/content/classes/Signature).
...
Creates a new [**Signature**](/cn/sdk/content/classes/Signature).

If no `sig` is provided, a new [**Signature**](/cn/sdk/content/classes/Signature) is created with default values.
...
| :------ | :------ | :------ |
| `sig`? | [`SignatureLike`](/cn/sdk/content/type-aliases/SignatureLike) | The signature to create. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `v` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The `v` value from the signature. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `chainId` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The chain ID. |
| `v` | `27` \| `28` | The `v` value. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `v` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The `v` value. |

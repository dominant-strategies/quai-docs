...
A FixedNumber represents a value over its [**FixedFormat**](/cn/sdk/content/type-aliases/FixedFormat) arithmetic field.
...
The value as an integer, based on the smallest unit the [**decimals**](/cn/sdk/content/classes/FixedNumber#decimals) allow.
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `this` added to `other`. A
...
| :------ | :------ | :------ |
| `other` | [`FixedNumber`](/cn/sdk/content/classes/FixedNumber) | The value to add to `this`. |
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `this` added to `other`, ignoring overflow.
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) which is the smallest **integer** that is greater than or
equal to `this`.
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `other` | [`FixedNumber`](/cn/sdk/content/classes/FixedNumber) | The value to compare to `this`. |
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `this` divided by `other`, ignoring
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `other` | [`FixedNumber`](/cn/sdk/content/classes/FixedNumber) | The value to divide `this` by. |
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `this` divided by `other`. A
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) which is the largest **integer** that is less than or equal to
`this`.
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `this` multiplied by `other`. A
[NumericFaultError](../interfaces/NumericFaultError) is thrown if overflow occurs.
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `other` | [`FixedNumber`](/cn/sdk/content/classes/FixedNumber) | The value to multiply `this` by. |
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `this` multiplied by `other`, ignoring
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the decimal component rounded up on ties at `decimals`
places.
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `other` subtracted from `this`. A
[NumericFaultError](../interfaces/NumericFaultError) is thrown if overflow occurs.
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `other` | [`FixedNumber`](/cn/sdk/content/classes/FixedNumber) | The value to subtract from `this`. |
...
Returns a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the result of `other` subtracted from `this`, ignoring
overflow.
...
Return a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the same value but has had its field set to `format`.
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `format` | [`FixedFormat`](/cn/sdk/content/type-aliases/FixedFormat) | The new format for the value. |
...
Creates a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) with the big-endian representation `value` with `format`.
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_value` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The big-endian representation of the value. |
| `_format`? | [`FixedFormat`](/cn/sdk/content/type-aliases/FixedFormat) | The format for the FixedNumber. |
...
Creates a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) for `value` with `format`.
...
Creates a new [**FixedNumber**](/cn/sdk/content/classes/FixedNumber) for `value` divided by `decimal` places with `format`.
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_value` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The value to create a FixedNumber for. |
| `_decimals`? | [`Numeric`](/cn/sdk/content/type-aliases/Numeric) | The number of decimal places in `value`. |
| `_format`? | [`FixedFormat`](/cn/sdk/content/type-aliases/FixedFormat) | The format for the FixedNumber. |

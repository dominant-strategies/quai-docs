...
- `AbstractTransaction`\<[`Signature`](/cn/sdk/content/classes/Signature)\>
...
`null` \| [`AccessList`](/cn/sdk/content/type-aliases/AccessList)
...
`undefined` \| [`Zone`](/cn/sdk/content/enumerations/Zone)
...
[**unsignedSerialized** ](/cn/sdk/content/classes/QiTransaction#unsignedserialized).

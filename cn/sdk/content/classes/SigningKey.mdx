...
| Parameter | Type |
| :------ | :------ |
| `privateKey` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) |
...
| :------ | :------ | :------ |
| `other` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The other key to compute the shared secret with. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `digest` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The data to sign. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `p0` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The first point to add. |
| `p1` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The second point to add. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `key` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The key to compute the public key for. |
| `compressed`? | `boolean` | Whether to return the compressed public key. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `digest` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The data that was signed. |
| `signature` | [`SignatureLike`](/cn/sdk/content/type-aliases/SignatureLike) | The signature of the data. |

...
| :------ | :------ |
| `address` | `string` |
| `provider`? | `null` \| [`Provider`](/cn/sdk/content/interfaces/Provider) |
...
| `provider` | `readonly` | `null` \| [`Provider`](/cn/sdk/content/interfaces/Provider) | The provider this signer is connected to. | [`AbstractSigner`](/cn/sdk/content/classes/AbstractSigner).`provider` |

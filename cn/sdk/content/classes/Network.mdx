...
| `chainId` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The network chain ID. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `value` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The new network chain ID. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `network`? | [`Networkish`](/cn/sdk/content/type-aliases/Networkish) | The network to get. |
...
| `networkFunc` | () => [`Network`](/cn/sdk/content/classes/Network) | The function to create the Network. |

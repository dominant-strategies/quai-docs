...
Additional schemes can be added globally using [**registerGateway**](/cn/sdk/content/classes/FetchRequest#registergateway).
...
[**registerGetUrl**](/cn/sdk/content/classes/FetchRequest#registergeturl). If this has been set, setting is to `null` will cause this
...
`null` \| [`FetchPreflightFunc`](/cn/sdk/content/type-aliases/FetchPreflightFunc)
...
[**FetchResponse.throwThrottleError**](/cn/sdk/content/classes/FetchResponse#throwthrottleerror).

#### Returns

`null` \| [`FetchProcessFunc`](/cn/sdk/content/type-aliases/FetchProcessFunc)
...
`null` \| [`FetchRetryFunc`](/cn/sdk/content/type-aliases/FetchRetryFunc)
...
[**send**](/cn/sdk/content/classes/FetchRequest#send).
...
Returns a new [**FetchRequest**](/cn/sdk/content/classes/FetchRequest) that represents the redirection to `location`.
...
`null` \| [`FetchGatewayFunc`](/cn/sdk/content/type-aliases/FetchGatewayFunc)
...
If [**lockConfig**](/cn/sdk/content/classes/FetchRequest#lockconfig) has been called, no change is made and this throws.
...
| `func` | [`FetchGatewayFunc`](/cn/sdk/content/type-aliases/FetchGatewayFunc) | The gateway function to use. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `getUrl` | [`FetchGetUrlFunc`](/cn/sdk/content/type-aliases/FetchGetUrlFunc) | The function to use for fetching HTTP and HTTPS URIs. |

...
| :------ | :------ | :------ |
| `key` | `string` \| [`SigningKey`](/cn/sdk/content/classes/SigningKey) | The private key. |
...
| `#signingKey` | `private` | [`SigningKey`](/cn/sdk/content/classes/SigningKey) | The signing key used for signing payloads. | `BaseWallet.#signingKey` |
| `provider` | `readonly` | `null` \| [`Provider`](/cn/sdk/content/interfaces/Provider) | The provider this signer is connected to. | `BaseWallet.provider` |
...
The [**SigningKey**](/cn/sdk/content/classes/SigningKey) used for signing payloads.
...
| `progressCallback`? | [`ProgressCallback`](/cn/sdk/content/type-aliases/ProgressCallback) | An optional callback to keep the user informed. |
...
[**ProgressCallback**](/cn/sdk/content/type-aliases/ProgressCallback) to keep the user informed.
...
| `progress`? | [`ProgressCallback`](/cn/sdk/content/type-aliases/ProgressCallback) | An optional callback to keep the user informed. |

#### Returns

`Promise`\<[`Wallet`](/cn/sdk/content/classes/Wallet)\>
...
The [**fromEncryptedJson**](/cn/sdk/content/classes/Wallet#fromencryptedjson) method is preferred, as this method will lock up and
...
[`QuaiHDWallet`](/cn/sdk/content/classes/QuaiHDWallet) \| [`Wallet`](/cn/sdk/content/classes/Wallet)

...
A [**BaseContract**](/cn/sdk/content/classes/BaseContract) with no type guards on its methods or events.

## Extends

- [`BaseContract`](/cn/sdk/content/classes/BaseContract)\<`this`\> & `Omit`\<[`ContractInterface`](/cn/sdk/content/interfaces/ContractInterface), keyof [`BaseContract`](/cn/sdk/content/classes/BaseContract)\>

## Properties

| Property | Modifier | Type | Description | Inherited from |
| :------ | :------ | :------ | :------ | :------ |
| `fallback` | `readonly` | `null` \| [`WrappedFallback`](/cn/sdk/content/interfaces/WrappedFallback) | The fallback or receive function if any. | `_ContractBase().fallback` |
| `filters` | `readonly` | `Record`\<`string`, [`ContractEvent`](/cn/sdk/content/interfaces/ContractEvent)\<`any`[]\>\> | All the Events available on this contract. | `_ContractBase().filters` |
| `interface` | `readonly` | [`Interface`](/cn/sdk/content/classes/Interface) | The contract Interface. | `_ContractBase().interface` |
...
| `target` | `readonly` | `string` \| [`Addressable`](/cn/sdk/content/interfaces/Addressable) | The target to connect to.<br /><br />This can be an address or any [Addressable](../interfaces/Addressable), such as another contract. To get the<br />resolved address, use the `getAddress` method. | `_ContractBase().target` |
...
`Promise`\<[`Contract`](/cn/sdk/content/classes/Contract)\>

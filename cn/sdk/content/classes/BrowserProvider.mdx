...
| :------ | :------ | :------ |
| `ethereum` | [`Eip1193Provider`](/cn/sdk/content/interfaces/Eip1193Provider) | The EIP-1193 provider. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `payload` | [`JsonRpcPayload`](/cn/sdk/content/type-aliases/JsonRpcPayload) | The JSON-RPC payload. |
| `error` | [`JsonRpcError`](/cn/sdk/content/type-aliases/JsonRpcError) | The JSON-RPC error. |
...
| `shard`? | [`Shard`](/cn/sdk/content/enumerations/Shard) | - |

...
The ABI can be specified by [any supported format](/cn/sdk/content/type-aliases/InterfaceAbi).
...
| :------ | :------ | :------ |
| `fragments` | [`InterfaceAbi`](/cn/sdk/content/type-aliases/InterfaceAbi) | The ABI fragments. |
...
| :------ | :------ | :------ | :------ |
| `deploy` | `readonly` | [`ConstructorFragment`](/cn/sdk/content/classes/ConstructorFragment) | The Contract constructor. |
| `fallback` | `readonly` | `null` \| [`FallbackFragment`](/cn/sdk/content/classes/FallbackFragment) | The Fallback method, if any. |
| `fragments` | `readonly` | readonly [`Fragment`](/cn/sdk/content/classes/Fragment)[] | All the Contract ABI members (i.e. methods, events, errors, etc). |
...
Decodes the result `data` (e.g. from an `quai_call`) for the specified error (see [**getError**](/cn/sdk/content/classes/Interface#geterror)
...
| Parameter | Type |
| :------ | :------ |
| `fragment` | `string` \| [`ErrorFragment`](/cn/sdk/content/classes/ErrorFragment) |
| `data` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) |
...
[**getFunction**](/cn/sdk/content/classes/Interface#getfunction) for valid values for `fragment`).

Most developers should prefer the [**parseTransaction**](/cn/sdk/content/classes/Interface#parsetransaction) method instead, which will
...
| Parameter | Type |
| :------ | :------ |
| `fragment` | `string` \| [`FunctionFragment`](/cn/sdk/content/classes/FunctionFragment) |
| `data` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) |
...
[**getFunction**](/cn/sdk/content/classes/Interface#getfunction) for valid values for `key`).
...
`error` (see [**getError**](/cn/sdk/content/classes/Interface#geterror) for valid values for `fragment`) with the `values`.
...
[**getFunction**](/cn/sdk/content/classes/Interface#getfunction) for valid values for `fragment`) with the `values`.
...
[**getFunction**](/cn/sdk/content/classes/Interface#getfunction) for valid values for `fragment`) with `values`.
...
Get the [**ErroFragment**](/cn/sdk/content/classes/ErrorFragment) for `key`, which may be an error selector, error name or error
...
`null` \| [`ErrorFragment`](/cn/sdk/content/classes/ErrorFragment)
...
Get the [**EventFragment**](/cn/sdk/content/classes/EventFragment) for `key`, which may be a topic hash, event name or event
signature that belongs to the ABI.
...
`null` \| [`EventFragment`](/cn/sdk/content/classes/EventFragment)
...
Get the [**FunctionFragment**](/cn/sdk/content/classes/FunctionFragment) for `key`, which may be a function selector, function name
...
`null` \| [`FunctionFragment`](/cn/sdk/content/classes/FunctionFragment)
...
[**EventFragment**](/cn/sdk/content/classes/EventFragment) may require refinement.
...
[**FunctionFragment**](/cn/sdk/content/classes/FunctionFragment) may require refinement.
...
`null` \| [`ErrorDescription`](/cn/sdk/content/classes/ErrorDescription)
...
`null` \| [`LogDescription`](/cn/sdk/content/classes/LogDescription)
...
| `tx` | `object` |
| `tx.data` | `string` |
| `tx.value`? | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) |

#### Returns

`null` \| [`TransactionDescription`](/cn/sdk/content/classes/TransactionDescription)
...
Creates a new [**Interface**](/cn/sdk/content/classes/Interface) from the ABI `value`.

The `value` may be provided as an existing [**Interface**](/cn/sdk/content/classes/Interface) object, a JSON-encoded ABI or any
...
| Parameter | Type |
| :------ | :------ |
| `value` | [`Interface`](/cn/sdk/content/classes/Interface) \| [`InterfaceAbi`](/cn/sdk/content/type-aliases/InterfaceAbi) |

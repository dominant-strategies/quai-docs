...
network, however, if your use case requires a single address Quai address, you can use the [Wallet](/cn/sdk/content/classes/Wallet) class.
...
- `AbstractHDWallet`\<[`NeuteredAddressInfo`](/cn/sdk/content/interfaces/NeuteredAddressInfo)\>
...
`null` \| [`NeuteredAddressInfo`](/cn/sdk/content/interfaces/NeuteredAddressInfo)
...
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone in which to retrieve the next address. |

#### Returns

`Promise`\<[`NeuteredAddressInfo`](/cn/sdk/content/interfaces/NeuteredAddressInfo)\>
...
| `domain` | [`TypedDataDomain`](/cn/sdk/content/interfaces/TypedDataDomain) | The domain information of the typed data, defining the scope of the signature. |
| `types` | `Record`\<`string`, [`TypedDataField`](/cn/sdk/content/interfaces/TypedDataField)[]\> | The types of the data to be signed, mapping each data type name<br />  to its fields. |
...
`Promise`\<[`QuaiHDWallet`](/cn/sdk/content/classes/QuaiHDWallet)\>

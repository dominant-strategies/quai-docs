...
[**_emit**](/cn/sdk/content/classes/SocketSubscriber#_emit) to manage the events.
...
| :------ | :------ | :------ |
| `provider` | [`SocketProvider`](/cn/sdk/content/classes/SocketProvider) | The socket provider. |
...
[`Subscriber`](/cn/sdk/content/interfaces/Subscriber).[`pause`](/cn/sdk/content/interfaces/Subscriber#pause)
...
[`Subscriber`](/cn/sdk/content/interfaces/Subscriber).[`resume`](/cn/sdk/content/interfaces/Subscriber#resume)
...
[`Subscriber`](/cn/sdk/content/interfaces/Subscriber).[`start`](/cn/sdk/content/interfaces/Subscriber#start)
...
[`Subscriber`](/cn/sdk/content/interfaces/Subscriber).[`stop`](/cn/sdk/content/interfaces/Subscriber#stop)

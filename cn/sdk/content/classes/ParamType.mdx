...
Each input and output of a [**Fragment**](/cn/sdk/content/classes/Fragment) is an Array of [**ParamType**](/cn/sdk/content/classes/ParamType).

## Properties

| Property | Modifier | Type | Description |
| :------ | :------ | :------ | :------ |
| `arrayChildren` | `readonly` | `null` \| [`ParamType`](/cn/sdk/content/classes/ParamType) | The type of each child in the array.<br /><br />For non-array types this is `null`. |
...
| `components` | `readonly` | `null` \| readonly [`ParamType`](/cn/sdk/content/classes/ParamType)[] | The components for the tuple.<br /><br />For non-tuple types this is `null`. |
...
This provides a type guard ensuring that [**arrayChildren**](/cn/sdk/content/classes/ParamType) and
[**arrayLength**](/cn/sdk/content/classes/ParamType) are non-null.
...
This provides a type guard ensuring that [**indexed**](/cn/sdk/content/classes/ParamType) is non-null.
...
This provides a type guard ensuring that [**components**](/cn/sdk/content/classes/ParamType) is non-null.
...
| :------ | :------ |
| `value` | `any` |
| `process` | [`ParamTypeWalkFunc`](/cn/sdk/content/type-aliases/ParamTypeWalkFunc) |
...
| :------ | :------ |
| `value` | `any` |
| `process` | [`ParamTypeWalkAsyncFunc`](/cn/sdk/content/type-aliases/ParamTypeWalkAsyncFunc) |

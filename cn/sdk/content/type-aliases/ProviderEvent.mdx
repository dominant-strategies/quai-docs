...
A **ProviderEvent** provides the types of events that can be subscribed to on a [**Provider**](/cn/sdk/content/interfaces/Provider).
...
[**EventFilter**](/cn/sdk/content/interfaces/EventFilter) - calls the listener with each matching log

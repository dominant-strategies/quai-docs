...
[**Utf8ErrorFunc**](/cn/sdk/content/type-aliases/Utf8ErrorFunc) API. (default: [error](Utf8ErrorFuncs))

## Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `bytes` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The UTF-8 data to convert. |
| `onError`? | [`Utf8ErrorFunc`](/cn/sdk/content/type-aliases/Utf8ErrorFunc) | The error handling function. |

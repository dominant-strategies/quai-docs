...
| `_salt` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The salt value. |
| `_initCodeHash` | [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | The hash of the init code. |

...
- [`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod)\<`A`, `R`, `D`\>
...
| `A` *extends* `any`[] | `any`[] |
| `R` | `any` |
| `D` *extends* `R` \| [`ContractTransactionResponse`](/cn/sdk/content/classes/ContractTransactionResponse) | `R` \| [`ContractTransactionResponse`](/cn/sdk/content/classes/ContractTransactionResponse) |
...
| :------ | :------ | :------ | :------ |
| `fragment` | [`FunctionFragment`](/cn/sdk/content/classes/FunctionFragment) | The fragment of the Contract method. This will throw on ambiguous method names. | [`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).`fragment` |
| `name` | `string` | The name of the Contract method. | [`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).`name` |
...
[`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).[`estimateGas`](/cn/sdk/content/interfaces/BaseContractMethod#estimategas)
...
[`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).[`getFragment`](/cn/sdk/content/interfaces/BaseContractMethod#getfragment)
...
[`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).[`populateTransaction`](/cn/sdk/content/interfaces/BaseContractMethod#populatetransaction)
...
[`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).[`send`](/cn/sdk/content/interfaces/BaseContractMethod#send)
...
[`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).[`staticCall`](/cn/sdk/content/interfaces/BaseContractMethod#staticcall)
...
[`BaseContractMethod`](/cn/sdk/content/interfaces/BaseContractMethod).[`staticCallResult`](/cn/sdk/content/interfaces/BaseContractMethod#staticcallresult)

...
Account data includes the [**balance**](/cn/sdk/content/interfaces/Provider#getbalance),
[**getTransactionCount**](/cn/sdk/content/interfaces/Provider#gettransactioncount), [**code**](/cn/sdk/content/interfaces/Provider#getcode) and
[**state trie storage**](/cn/sdk/content/interfaces/Provider#getstorage).

Simulating execution can be used to [**call**](/cn/sdk/content/interfaces/Provider#call), [**estimateGas**](/cn/sdk/content/interfaces/Provider#estimategas)
and [**get transaction result**](/cn/sdk/content/interfaces/Provider#gettransactionresult).

The [**broadcastTransaction**](/cn/sdk/content/interfaces/Provider#broadcasttransaction) is the only method which allows updating the
...
- [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner).[`EventEmitterable`](/cn/sdk/content/interfaces/EventEmitterable)\<[`ProviderEvent`](/cn/sdk/content/type-aliases/ProviderEvent)\>

## Properties

| Property | Type | Description | Overrides | Inherited from |
| :------ | :------ | :------ | :------ | :------ |
| `provider` | [`Provider`](/cn/sdk/content/interfaces/Provider) | The provider iteself.<br /><br />This is part of the necessary API for executing a contract, as it provides a common property on any<br />[**ContractRunner**](/cn/sdk/content/interfaces/ContractRunner) that can be used to access the read-only portion of the runner. | [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner).`provider` | [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner).`provider` |
| `sendTransaction?` | (`tx`: [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest)) => `Promise`\<[`TransactionResponse`](/cn/sdk/content/type-aliases/TransactionResponse)\> | Required for state mutating calls | [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner).`sendTransaction` | [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner).`sendTransaction` |
...
| Parameter | Type |
| :------ | :------ |
| `event` | [`ProviderEvent`](/cn/sdk/content/type-aliases/ProviderEvent) |
| `listener` | [`Listener`](/cn/sdk/content/type-aliases/Listener) |
| `zone`? | [`Zone`](/cn/sdk/content/enumerations/Zone) |

#### Returns

`Promise`\<[`Provider`](/cn/sdk/content/interfaces/Provider)\>
...
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The zone to broadcast the transaction to. |
| `signedTx` | `string` | The signed transaction to broadcast. |
| `from`? | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address that signed the transaction. |
...
| `value` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The amount to convert |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction to simulate. |
...
`Promise`\<[`AccessList`](/cn/sdk/content/type-aliases/AccessList)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction to estimate the gas for. |
...
for that `blockTag`, the balance is as of that [**BlockTag**](/cn/sdk/content/type-aliases/BlockTag).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address to fetch the balance for. |
| `blockTag`? | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The block tag to fetch the balance from. |
...
included and the [**Block**](/cn/sdk/content/classes/Block) object will not need to make remote calls for getting transactions.
...
| `blockHashOrBlockTag` | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The block hash or block tag to fetch. |
| `prefetchTxs`? | `boolean` | If true, prefetch the transactions. |

#### Returns

`Promise`\<`null` \| [`Block`](/cn/sdk/content/classes/Block)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `shard` | [`Shard`](/cn/sdk/content/enumerations/Shard) | The shard to fetch the block number from. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address to fetch the code for. |
| `blockTag`? | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The block tag to fetch the code from. |
...
Get the best guess at the recommended [**FeeData**](/cn/sdk/content/classes/FeeData).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | The shard to fetch the fee data from. |
| `txType` | `boolean` | The transaction type to fetch the fee data for (true for Quai, false for Qi) |

#### Returns

`Promise`\<[`FeeData`](/cn/sdk/content/classes/FeeData)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address to fetch the locked balance for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `filter` | [`Filter`](/cn/sdk/content/interfaces/Filter) \| [`FilterByBlockHash`](/cn/sdk/content/interfaces/FilterByBlockHash) | The filter to apply. |

#### Returns

`Promise`\<[`Log`](/cn/sdk/content/classes/Log)[]\>
...
Get the connected [**Network**](/cn/sdk/content/classes/Network).

#### Returns

`Promise`\<[`Network`](/cn/sdk/content/classes/Network)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address to fetch the UTXO entries for. |
...
| :------ | :------ | :------ |
| `zone` | [`Zone`](/cn/sdk/content/enumerations/Zone) | - |
| `blockTag` | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | - |
| `amt` | `bigint` | The amount in quais to get the rate for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address to fetch the storage from. |
| `position` | [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The position to fetch the storage from. |
| `blockTag`? | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The block tag to fetch the storage from. |
...
`Promise`\<`null` \| [`TransactionResponse`](/cn/sdk/content/type-aliases/TransactionResponse) \| `ExternalTransactionResponse`\>
...
of that [**BlockTag**](/cn/sdk/content/type-aliases/BlockTag).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/cn/sdk/content/type-aliases/AddressLike) | The address to fetch the transaction count for. |
| `blockTag`? | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The block tag to fetch the transaction count from. |
...
`Promise`\<`null` \| [`TransactionReceipt`](/cn/sdk/content/classes/TransactionReceipt)\>
...
| :------ | :------ | :------ |
| `shard` | [`Shard`](/cn/sdk/content/enumerations/Shard) | The shard to fetch the block from. |
| `blockTag`? | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The block tag to fetch. |

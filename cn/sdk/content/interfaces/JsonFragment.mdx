...
| `inputs?` | `readonly` | readonly [`JsonFragmentType`](/cn/sdk/content/interfaces/JsonFragmentType)[] | The input parameters. |
| `name?` | `readonly` | `string` | The name of the error, event, function, etc. |
| `outputs?` | `readonly` | readonly [`JsonFragmentType`](/cn/sdk/content/interfaces/JsonFragmentType)[] | The output parameters. |

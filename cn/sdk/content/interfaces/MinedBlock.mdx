...
An Interface to indicate a [**Block**](/cn/sdk/content/classes/Block) has been included in the blockchain. This asserts a Type Guard
...
| :------ | :------ | :------ | :------ | :------ |
| `provider` | `readonly` | [`Provider`](/cn/sdk/content/interfaces/Provider) | The provider connected to the block used to fetch additional details if necessary. | [`Block`](/cn/sdk/content/classes/Block).`provider` |
...
[**getBlock**](/cn/sdk/content/interfaces/Provider#getblock).
...
[`Block`](/cn/sdk/content/classes/Block).[`getExtTransaction`](/cn/sdk/content/classes/Block#getexttransaction)
...
[`Block`](/cn/sdk/content/classes/Block).[`getPrefetchedTransaction`](/cn/sdk/content/classes/Block#getprefetchedtransaction)
...
[`Block`](/cn/sdk/content/classes/Block).[`getTransaction`](/cn/sdk/content/classes/Block#gettransaction)
...
[`Block`](/cn/sdk/content/classes/Block).[`isMined`](/cn/sdk/content/classes/Block#ismined)
...
[`Block`](/cn/sdk/content/classes/Block).[`toJSON`](/cn/sdk/content/classes/Block#tojson)

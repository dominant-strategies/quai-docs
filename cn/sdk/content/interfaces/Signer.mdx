...
- [`Addressable`](/cn/sdk/content/interfaces/Addressable).[`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner)

## Properties

| Property | Type | Description | Overrides |
| :------ | :------ | :------ | :------ |
| `provider` | `null` \| [`Provider`](/cn/sdk/content/interfaces/Provider) | The [**Provider**](/cn/sdk/content/interfaces/Provider) attached to this Signer (if any). | [`ContractRunner`](/cn/sdk/content/interfaces/ContractRunner).`provider` |
...
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction to call. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `provider` | `null` \| [`Provider`](/cn/sdk/content/interfaces/Provider) | The Provider to connect to. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) |  |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction to estimate gas for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `blockTag`? | [`BlockTag`](/cn/sdk/content/type-aliases/BlockTag) | The blocktag to base the transaction count on, keep in mind many nodes do not honour this value<br />  and silently ignore it [default: `"latest"`] |
...
Prepares a [TransactionRequest](/cn/sdk/content/type-aliases/TransactionRequest) for calling:
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The call to prepare |

#### Returns

`Promise`\<[`TransactionLike`](/cn/sdk/content/interfaces/TransactionLike)\>
...
Prepares a [TransactionRequest](/cn/sdk/content/type-aliases/TransactionRequest) for sending to the network by populating any missing properties:
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction to prepare. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction to send. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/cn/sdk/content/type-aliases/TransactionRequest) | The transaction to sign. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `domain` | [`TypedDataDomain`](/cn/sdk/content/interfaces/TypedDataDomain) | The domain of the typed data. |
| `types` | `Record`\<`string`, [`TypedDataField`](/cn/sdk/content/interfaces/TypedDataField)[]\> | The types of the typed data. |

...
| :------ | :------ | :------ |
| `chainId?` | `null` \| [`BigNumberish`](/cn/sdk/content/type-aliases/BigNumberish) | The chain ID of the signing domain. |
| `name?` | `null` \| `string` | The human-readable name of the signing domain. |
| `salt?` | `null` \| [`BytesLike`](/cn/sdk/content/type-aliases/BytesLike) | A salt used for purposes decided by the specific domain. |

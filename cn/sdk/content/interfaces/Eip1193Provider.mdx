...
injected providers, which the [**BrowserProvider**](/cn/sdk/content/classes/BrowserProvider) accepts and exposes the API of.
...
| `request.shard`? | [`Shard`](/cn/sdk/content/enumerations/Shard) | The shard to send the request to. |

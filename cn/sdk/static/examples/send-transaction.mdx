...
<Tabs>
  <Tab title="Quai Transactions">
    <Steps>
      <Step title="Configure Wallet">
        To send a Quai transaction, you'll first need to connect a [Wallet](/cn/sdk/content/classes/Wallet) or [QuaiHDWallet](/cn/sdk/content/classes/QuaiHDWallet) to a [Provider](/cn/sdk/content/interfaces/Provider).
      ...
      <Step title="Build Transaction">
        Then, build the transaction you want to send using the [QuaiTransactionRequest](/cn/sdk/content/type-aliases/TransactionRequest) type.
        ...
        <Tip>
          The above transaction is a simple value transfer. Additional transaction params for more complex transactions can be found in the [QuaiTransaction](/cn/sdk/content/classes/QuaiTransaction) class.
        </Tip>
      </Step>
  ...
  <Tab title="Qi Transactions">
       <Steps>
      <Step title="Configure Wallet">
        To send a Qi transaction, you'll first need to connect a [QiHDWallet](/cn/sdk/content/classes/QiHDWallet) to a [Provider](/cn/sdk/content/interfaces/Provider) and sync the UTXO set.
      ...
      <Step title="Build Transaction">
        Using the addresses and outpoints from the UTXO set, build the transaction you want to send using the [QiTransactionRequest](/cn/sdk/content/type-aliases/QiTransactionRequest) type.

...
<CardGroup>
	...
	>
		Checks if the provided address is within smart contract's context.
	</Card>
	<Card
		title='etx'
		icon='arrows-cross'
...
<AccordionGroup>
  ...
  <Accordion title="etx">
    External transactions, also called cross-chain transfers, can be initiated by smart contract via the `etx` opcode.

...
- _Access to a Quai node_: you can do this either by [running your own node](/guides/client/node), [accessing a publicly available node](/build/networks), or through API key via a node service.
...
Information on how to deploy a simple smart contract with hardhat can be found in the [Solidity Deployment Tutorial](/guides/development/solidity).
...
Tutorials on how to deploy a multi-chain smart contracts with hardhat can be found in the [SolidityX Deployment Tutorial](/guides/development/solidityX).

Resources for automated cross-chain deployment and sister contract linking and be found in the [`quais-by-example` repository](https://github.com/dominant-strategies/quais-by-example/).

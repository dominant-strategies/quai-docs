...
<CardGroup cols={3}>
	<Card
		title='Github'
		icon='github'
		href='https://github.com/dominant-strategies/quais.js'
	/>
	<Card
		title='Package'
		icon='npm'
...
A polling shim-package that adds polling functionality to quais.js in a simple but highly visible way.

<CardGroup cols={3}>
	<Card
		title='GitHub'
		icon='github'
		href='https://github.com/dominant-strategies/quais-shim'
	/>
	<Card
		title='Package'
		icon='npm'
		href='https://www.npmjs.com/package/quais-polling'
	/>
	<Card
		title='Examples'
		icon='code'

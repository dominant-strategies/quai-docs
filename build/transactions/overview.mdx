...
Transactions are cryptographically signed messages sent and executed on Zone chains within Quai Network. Regardless of what ledger or chain you are on within the network, every state-changing operation requires a signed transaction.

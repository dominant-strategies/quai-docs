...
<Tip>
  The public developer network is currently running the **Golden Age Testnet** version of the Quai Protocol, compatible with [quais v1.0.0-alpha](https://www.npmjs.com/package/quais?activeTab=versions) and later.
...
| --------- | ---------- | ------------ | --------------------------------------- |
| Cyprus-1  | [0 0]      | N/A          | https://rpc.cyprus1.sandbox.quaiscan.io |
| Cyprus-2  | [0 1]      | N/A          | https://rpc.cyprus2.sandbox.quaiscan.io |
| Cyprus-3  | [0 2]      | N/A          | https://rpc.cyprus3.sandbox.quaiscan.io |
| Paxos-1   | [1 0]      | N/A          | https://rpc.paxos1.sandbox.quaiscan.io  |
| Paxos-2   | [1 1]      | N/A          | https://rpc.paxos2.sandbox.quaiscan.io  |
| Paxos-3   | [1 2]      | N/A          | https://rpc.paxos3.sandbox.quaiscan.io  |
| Hydra-1   | [2 0]      | N/A          | https://rpc.hydra1.sandbox.quaiscan.io  |
| Hydra-2   | [2 1]      | N/A          | https://rpc.hydra2.sandbox.quaiscan.io  |
| Hydra-3   | [2 2]      | N/A          | https://rpc.hydra3.sandbox.quaiscan.io  |
...
You can easily spin up a pre-configured development environment using the [Local Node Runner](https://github.com/dominant-strategies/quai-compose) and [Docker compose](https://docs.docker.com/compose/). The Local Node Runner spins up a containerized local node environment for Quai complete with multiple shards, a running CPU miner, and accounts pre-loaded with Quai tokens.

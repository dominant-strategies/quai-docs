...
<AccordionGroup>
  ...
  <Accordion title="Interoperability Opcodes">
    ...
    [Solidity](/build/smart-contracts/languages#solidity) smart contracts.
  </Accordion>
  <Accordion title="Available Tooling">
    Because Quai has implemented new EVM opcodes, only [Quai compatible
    tooling](#available-tooling) can be used to develop on the network.
  </Accordion>
  <Accordion title="Transaction Types">
    Quai utilizes [new transaction

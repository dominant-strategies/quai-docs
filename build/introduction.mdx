...
<AccordionGroup>
	...
	<Accordion title='Interoperability Opcodes'>
		Quai’s EVM handles traditional [Solidity](/develop/smart-contracts/languages.md#solidity-1) smart contracts, but also
		[SolidityX](/develop/smart-contracts/languages.md#solidityx-1) smart contracts – which adds support for opcodes added to handle
		cross-chain interactions between any of the Zone chains.
	</Accordion>

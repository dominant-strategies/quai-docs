...
When using the [**Interface.parseTransaction**](/content/classes/Interface#parsetransaction) to automatically match a
...
| :------ | :------ | :------ | :------ |
| `args` | `readonly` | [`Result`](/content/classes/Result) | The arguments passed to the Function from the transaction `data`. |
| `fragment` | `readonly` | [`FunctionFragment`](/content/classes/FunctionFragment) | The matching fragment from the transaction `data`. |

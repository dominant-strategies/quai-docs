...
| `minerTip` | `readonly` | `null` \| `bigint` | The maximum priority fee (per unit of gas) to allow a validator to charge the sender. This is inclusive of the<br />[**gasPrice** ](/sdk/content/classes/QuaiTransactionResponse). | [`QuaiTransactionResponse`](/sdk/content/classes/QuaiTransactionResponse).`minerTip` |
...
[contract/wrappers.ts:141](https://github.com/dominant-strategies/quais.js/blob/b2ac1fd0778919e5fee7e72ee1eb16f6f0ceca10/src/contract/wrappers.ts#L141)

...
| --------- | ---------- | -------------------------------- | ------------------------------ | --------------------------- |
| cyprus    | [0 0]      | https://rpc.quai.network/cyprus1 | wss://rpc.quai.network/cyprus1 | https://graph.quai.network  |
...
| Zone Name | Zone Index | RPC Endpoint (https)                     | RPC Endpoint (wss)                     | GraphQL Endpoint                    |
| --------- | ---------- | ---------------------------------------- | -------------------------------------- | ----------------------------------- |
| cyprus    | [0 0]      | https://orchard.rpc.quai.network/cyprus1 | wss://orchard.rpc.quai.network/cyprus1 | https://orchard.graph.quai.network  |

...
- _Access to a Quai node_: you can do this either by [running your own node](/jp/guides/client/node), [accessing a publicly available node](/jp/build/networks), or through API key via a node service.
...
Information on how to deploy a simple smart contract with hardhat can be found in the [Solidity Deployment Tutorial](/jp/guides/development/solidity).

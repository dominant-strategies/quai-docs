...
<AccordionGroup>
  ...
  <Accordion title="API Methods and Namespace">
    The [Go-Quai client API](/jp/build/playground/introduction) closely resembles
  ...
  <Accordion title="Interoperability Opcodes">
    ...
    [Solidity](/jp/build/smart-contracts/solidity) smart contracts.
  </Accordion>
...
<CardGroup>
  ...
  <Card title="Local Node Runner" icon="terminal" href="/jp/guides/client/containerized-node">

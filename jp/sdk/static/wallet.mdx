...
The class most developers will want to use is [Wallet](/jp/sdk/content/classes/Wallet), **which can load a private key directly or from any common wallet format**.

The SDK also supports Hierarchical Deterministic (HD) wallets for both Quai and Qi ledgers. Developers who need access to low-level wallet details can opt to use the [QuaiHDWallet](/jp/sdk/content/classes/QuaiHDWallet) and [QiHDWallet](/jp/sdk/content/classes/QiHDWallet) classes.
...
Quai wallets can be initialized using either the [Wallet](/jp/sdk/content/classes/Wallet) class or the [QuaiHDWallet](/jp/sdk/content/classes/QuaiHDWallet) class.

The simplest wallet configuration is using the **Wallet** class. All that is needed to initiate a wallet is a private key and a provider. Once configured, the wallet acts similar to a [Signer](/jp/sdk/content/classes/Signer). 
...
The [QuaiHDWallet](/jp/sdk/content/classes/QuaiHDWallet) class provides additional low-level functionality on top of the base [Wallet](/jp/sdk/content/classes/Wallet) class, allowing for more granular control.
...
Qi wallets **can only be initialized** using the [QiHDWallet](/jp/sdk/content/classes/QiHDWallet) class.

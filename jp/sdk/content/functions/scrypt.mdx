...
| :------ | :------ | :------ |
| `_passwd` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The password to use. |
| `_salt` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The salt to use. |
...
| `progress`? | [`ProgressCallback`](/jp/sdk/content/type-aliases/ProgressCallback) | A callback to update the progress. |

...
It is preferred to use the [**async version**](/jp/sdk/content/functions/decryptKeystoreJson) instead, which allows a
[**ProgressCallback](/jp/sdk/content/type-aliases/ProgressCallback) to keep the user informed as to the decryption status.

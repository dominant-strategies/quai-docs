...
| `_key` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The key to use for the HMAC. |
| `_data` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The data to authenticate. |

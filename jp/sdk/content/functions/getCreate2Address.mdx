...
| `_salt` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The salt value. |
| `_initCodeHash` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The hash of the init code. |

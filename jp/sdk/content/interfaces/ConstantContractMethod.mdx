...
- [`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod)\<`A`, `R`, `R`\>
...
| :------ | :------ | :------ | :------ |
| `fragment` | [`FunctionFragment`](/jp/sdk/content/classes/FunctionFragment) | The fragment of the Contract method. This will throw on ambiguous method names. | [`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).`fragment` |
| `name` | `string` | The name of the Contract method. | [`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).`name` |
...
[`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).[`estimateGas`](/jp/sdk/content/interfaces/ContractMethod#estimategas)
...
[`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).[`getFragment`](/jp/sdk/content/interfaces/ContractMethod#getfragment)
...
[`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).[`populateTransaction`](/jp/sdk/content/interfaces/ContractMethod#populatetransaction)
...
[`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).[`send`](/jp/sdk/content/interfaces/ContractMethod#send)
...
[`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).[`staticCall`](/jp/sdk/content/interfaces/ContractMethod#staticcall)
...
[`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod).[`staticCallResult`](/jp/sdk/content/interfaces/ContractMethod#staticcallresult)

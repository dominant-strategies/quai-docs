...
- [`Addressable`](/jp/sdk/content/interfaces/Addressable).[`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner)

## Properties

| Property | Type | Description | Overrides |
| :------ | :------ | :------ | :------ |
| `provider` | `null` \| [`Provider`](/jp/sdk/content/interfaces/Provider) | The [**Provider**](/jp/sdk/content/interfaces/Provider) attached to this Signer (if any). | [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner).`provider` |
...
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/jp/sdk/content/type-aliases/TransactionRequest) | The transaction to call. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/jp/sdk/content/type-aliases/TransactionRequest) |  |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/jp/sdk/content/type-aliases/TransactionRequest) | The transaction to estimate gas for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `blockTag`? | [`BlockTag`](/jp/sdk/content/type-aliases/BlockTag) | The blocktag to base the transaction count on, keep in mind many nodes do not honour this value<br />  and silently ignore it [default: `"latest"`] |
...
Prepares a [TransactionRequest](/jp/sdk/content/type-aliases/TransactionRequest) for calling:
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/jp/sdk/content/type-aliases/TransactionRequest) | The call to prepare |

#### Returns

`Promise`\<[`TransactionLike`](/jp/sdk/content/interfaces/TransactionLike)\>
...
Prepares a [TransactionRequest](/jp/sdk/content/type-aliases/TransactionRequest) for sending to the network by populating any missing properties:
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/jp/sdk/content/type-aliases/TransactionRequest) | The transaction to prepare. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/jp/sdk/content/type-aliases/TransactionRequest) | The transaction to send. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/jp/sdk/content/type-aliases/TransactionRequest) | The transaction to sign. |

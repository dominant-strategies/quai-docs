...
injected providers, which the [**BrowserProvider**](/jp/sdk/content/classes/BrowserProvider) accepts and exposes the API of.
...
| `request.shard`? | [`Shard`](/jp/sdk/content/enumerations/Shard) | The shard to send the request to. |

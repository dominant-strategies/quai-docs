...
network, however, if your use case requires a single address Quai address, you can use the [Wallet](/jp/sdk/content/classes/Wallet) class.
...
- `AbstractHDWallet`\<[`NeuteredAddressInfo`](/jp/sdk/content/interfaces/NeuteredAddressInfo)\>
...
`null` \| [`NeuteredAddressInfo`](/jp/sdk/content/interfaces/NeuteredAddressInfo)
...
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone in which to retrieve the next address. |

#### Returns

`Promise`\<[`NeuteredAddressInfo`](/jp/sdk/content/interfaces/NeuteredAddressInfo)\>
...
| `domain` | [`TypedDataDomain`](/jp/sdk/content/interfaces/TypedDataDomain) | The domain information of the typed data, defining the scope of the signature. |
| `types` | `Record`\<`string`, [`TypedDataField`](/jp/sdk/content/interfaces/TypedDataField)[]\> | The types of the data to be signed, mapping each data type name<br />  to its fields. |
...
`Promise`\<[`QuaiHDWallet`](/jp/sdk/content/classes/QuaiHDWallet)\>

...
| :------ | :------ | :------ |
| `url` | `string` \| `string`[] \| [`WebSocketLike`](/jp/sdk/content/interfaces/WebSocketLike) \| [`WebSocketCreator`](/jp/sdk/content/type-aliases/WebSocketCreator) | The URL(s) or WebSocket object or creator. |
| `network`? | [`Networkish`](/jp/sdk/content/type-aliases/Networkish) | The network to connect to. |
| `options`? | [`JsonRpcApiProviderOptions`](/jp/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the JSON-RPC API provider. |
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`constructor`](/jp/sdk/content/classes/SocketProvider#constructors)
...
| :------ | :------ | :------ | :------ |
| `readyMap` | `Map`\<[`Shard`](/jp/sdk/content/enumerations/Shard), `boolean`\> | `...` | A map to track the readiness of each shard. |
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`_clearTimeout`](/jp/sdk/content/classes/SocketProvider#_cleartimeout)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`destroy`](/jp/sdk/content/classes/SocketProvider#destroy)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getActiveRegions`](/jp/sdk/content/classes/SocketProvider#getactiveregions)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getActiveZones`](/jp/sdk/content/classes/SocketProvider#getactivezones)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getLatestQiToQuaiRate`](/jp/sdk/content/classes/SocketProvider#getlatestqitoquairate)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getLatestQuaiToQiRate`](/jp/sdk/content/classes/SocketProvider#getlatestquaitoqirate)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getProtocolExpansionNumber`](/jp/sdk/content/classes/SocketProvider#getprotocolexpansionnumber)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getQiToQuaiRateAtBlock`](/jp/sdk/content/classes/SocketProvider#getqitoquairateatblock)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getQuaiToQiRateAtBlock`](/jp/sdk/content/classes/SocketProvider#getquaitoqirateatblock)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`getSigner`](/jp/sdk/content/classes/SocketProvider#getsigner)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`listAccounts`](/jp/sdk/content/classes/SocketProvider#listaccounts)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`pause`](/jp/sdk/content/classes/SocketProvider#pause)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`resume`](/jp/sdk/content/classes/SocketProvider#resume)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`send`](/jp/sdk/content/classes/SocketProvider#send)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`shardFromHash`](/jp/sdk/content/classes/SocketProvider#shardfromhash)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `shard` | [`Shard`](/jp/sdk/content/enumerations/Shard) | The shard identifier. |
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`zoneFromAddress`](/jp/sdk/content/classes/SocketProvider#zonefromaddress)
...
[`SocketProvider`](/jp/sdk/content/classes/SocketProvider).[`zoneFromHash`](/jp/sdk/content/classes/SocketProvider#zonefromhash)

...
- [`EventEmitterable`](/jp/sdk/content/interfaces/EventEmitterable)\<[`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName)\>

## Properties

| Property | Modifier | Type | Description |
| :------ | :------ | :------ | :------ |
| `fallback` | `readonly` | `null` \| [`WrappedFallback`](/jp/sdk/content/interfaces/WrappedFallback) | The fallback or receive function if any. |
| `filters` | `readonly` | `Record`\<`string`, [`ContractEvent`](/jp/sdk/content/interfaces/ContractEvent)\<`any`[]\>\> | All the Events available on this contract. |
| `interface` | `readonly` | [`Interface`](/jp/sdk/content/classes/Interface) | The contract Interface. |
| `runner` | `readonly` | `null` \| [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner) | The connected runner. This is generally a [**Provider**](../interfaces/Provider) or a<br />[**Signer**](../interfaces/Signer), which dictates what operations are supported.<br /><br />For example, a **Contract** connected to a [**Provider**](../interfaces/Provider) may only execute read-only<br />operations. |
| `target` | `readonly` | `string` \| [`Addressable`](/jp/sdk/content/interfaces/Addressable) | The target to connect to.<br /><br />This can be an address or any [Addressable](../interfaces/Addressable), such as another contract. To get the<br />resolved address, use the `getAddress` method. |
...
Alias for [**on**](/jp/sdk/content/classes/BaseContract#on).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName) | The event to listen for. |
| `listener` | [`Listener`](/jp/sdk/content/type-aliases/Listener) | The listener to call when the event is emitted. |

#### Returns

`Promise`\<[`BaseContract`](/jp/sdk/content/classes/BaseContract)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `target` | `string` \| [`Addressable`](/jp/sdk/content/interfaces/Addressable) | The target to connect to. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `runner` | `null` \| [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner) | The runner to use. |
...
`null` \| [`ContractTransactionResponse`](/jp/sdk/content/classes/ContractTransactionResponse)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName) | The event to emit. |
...
[`Addressable`](/jp/sdk/content/interfaces/Addressable).[`getAddress`](/jp/sdk/content/interfaces/Addressable#getaddress)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `key` | `string` \| [`EventFragment`](/jp/sdk/content/classes/EventFragment) | The name of the event to return. |

#### Returns

[`ContractEvent`](/jp/sdk/content/interfaces/ContractEvent)\<`any`[]\>
...
| :------ | :------ |
| `T` *extends* [`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod)\<`any`[], `any`, `any`, `T`\> | [`ContractMethod`](/jp/sdk/content/interfaces/ContractMethod)\<`any`[], `any`, `any`\> |

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `key` | `string` \| [`FunctionFragment`](/jp/sdk/content/classes/FunctionFragment) | The name of the function to return. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event`? | [`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName) | The event to count listeners for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event`? | [`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName) | The event to get listeners for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName) | The event to remove the listener from. |
| `listener`? | [`Listener`](/jp/sdk/content/type-aliases/Listener) | The listener to remove. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName) | The event to query. |
| `fromBlock`? | [`BlockTag`](/jp/sdk/content/type-aliases/BlockTag) | The block to start querying from. |
| `toBlock`? | [`BlockTag`](/jp/sdk/content/type-aliases/BlockTag) | The block to stop querying at. |

#### Returns

`Promise`\<([`EventLog`](/jp/sdk/content/classes/EventLog) \| [`Log`](/jp/sdk/content/classes/Log))[]\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event`? | [`ContractEventName`](/jp/sdk/content/type-aliases/ContractEventName) | The event to remove the listeners from. |
...
Alias for [**off**](/jp/sdk/content/classes/BaseContract#off).
...
| Type parameter | Value |
| :------ | :------ |
| `T` | [`ContractInterface`](/jp/sdk/content/interfaces/ContractInterface) |

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `abi` | [`Interface`](/jp/sdk/content/classes/Interface) \| [`InterfaceAbi`](/jp/sdk/content/type-aliases/InterfaceAbi) | The ABI to create the class from. |
...
| `abi` | [`Interface`](/jp/sdk/content/classes/Interface) \| [`InterfaceAbi`](/jp/sdk/content/type-aliases/InterfaceAbi) | The ABI to use. |
| `runner`? | `null` \| [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner) | The runner to use. |

#### Returns

[`BaseContract`](/jp/sdk/content/classes/BaseContract) & `Omit`\<`T`, keyof [`BaseContract`](/jp/sdk/content/classes/BaseContract)\>

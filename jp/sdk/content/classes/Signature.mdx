...
Returns a new identical [**Signature**](/jp/sdk/content/classes/Signature).
...
Creates a new [**Signature**](/jp/sdk/content/classes/Signature).

If no `sig` is provided, a new [**Signature**](/jp/sdk/content/classes/Signature) is created with default values.
...
| :------ | :------ | :------ |
| `sig`? | [`SignatureLike`](/jp/sdk/content/type-aliases/SignatureLike) | The signature to create. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `v` | [`BigNumberish`](/jp/sdk/content/type-aliases/BigNumberish) | The `v` value from the signature. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `chainId` | [`BigNumberish`](/jp/sdk/content/type-aliases/BigNumberish) | The chain ID. |
| `v` | `27` \| `28` | The `v` value. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `v` | [`BigNumberish`](/jp/sdk/content/type-aliases/BigNumberish) | The `v` value. |

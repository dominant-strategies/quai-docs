...
| :------ | :------ | :------ |
| `types` | readonly (`string` \| [`ParamType`](/jp/sdk/content/classes/ParamType))[] | Array of parameter types. |
| `data` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The ABI data to decode. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `types` | readonly (`string` \| [`ParamType`](/jp/sdk/content/classes/ParamType))[] | Array of parameter types to get default values for. |
...
Returns the shared singleton instance of a default [**AbiCoder**](/jp/sdk/content/classes/AbiCoder).
...
Returns a quais-compatible [**CallExceptionError**](/jp/sdk/content/interfaces/CallExceptionError) for the given result data.

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `action` | [`CallExceptionAction`](/jp/sdk/content/type-aliases/CallExceptionAction) | The action that triggered the exception. |
| `tx` | `object` | The transaction information. |
| `tx.data`? | `string` | - |
| `tx.from`? | `null` \| `string` | - |
| `tx.to`? | `null` \| `string` | - |
| `data` | `null` \| [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The data associated with the call exception. |

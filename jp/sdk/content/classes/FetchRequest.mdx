...
Additional schemes can be added globally using [**registerGateway**](/jp/sdk/content/classes/FetchRequest#registergateway).
...
[**registerGetUrl**](/jp/sdk/content/classes/FetchRequest#registergeturl). If this has been set, setting is to `null` will cause this
...
`null` \| [`FetchPreflightFunc`](/jp/sdk/content/type-aliases/FetchPreflightFunc)
...
[**FetchResponse.throwThrottleError**](/jp/sdk/content/classes/FetchResponse#throwthrottleerror).

#### Returns

`null` \| [`FetchProcessFunc`](/jp/sdk/content/type-aliases/FetchProcessFunc)
...
`null` \| [`FetchRetryFunc`](/jp/sdk/content/type-aliases/FetchRetryFunc)
...
[**send**](/jp/sdk/content/classes/FetchRequest#send).
...
Returns a new [**FetchRequest**](/jp/sdk/content/classes/FetchRequest) that represents the redirection to `location`.
...
`null` \| [`FetchGatewayFunc`](/jp/sdk/content/type-aliases/FetchGatewayFunc)
...
If [**lockConfig**](/jp/sdk/content/classes/FetchRequest#lockconfig) has been called, no change is made and this throws.
...
| `func` | [`FetchGatewayFunc`](/jp/sdk/content/type-aliases/FetchGatewayFunc) | The gateway function to use. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `getUrl` | [`FetchGetUrlFunc`](/jp/sdk/content/type-aliases/FetchGetUrlFunc) | The function to use for fetching HTTP and HTTPS URIs. |

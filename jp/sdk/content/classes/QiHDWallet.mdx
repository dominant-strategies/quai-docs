...
- Generating addresses for a specific account in any [Zone](/jp/sdk/content/enumerations/Zone)
...
- `AbstractHDWallet`\<[`QiAddressInfo`](/jp/sdk/content/interfaces/QiAddressInfo)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone to aggregate the balance for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `provider` | [`Provider`](/jp/sdk/content/interfaces/Provider) | The provider. |
...
`null` \| [`QiAddressInfo`](/jp/sdk/content/interfaces/QiAddressInfo)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone to get the balance for |
...
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | `undefined` | The zone to get change addresses from |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone`? | [`Zone`](/jp/sdk/content/enumerations/Zone) | Optional zone to filter addresses by |
...
`Promise`\<[`QiAddressInfo`](/jp/sdk/content/interfaces/QiAddressInfo)\>
...
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone in which to retrieve the next change address. |
...
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | `undefined` | - |
| `account` | `number` | `0` | - |
...
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone to get addresses from. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `outpoints` | [`OutpointInfo`](/jp/sdk/content/interfaces/OutpointInfo)[] | The outpoints to import. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone to filter outpoints for. |
...
| `originZone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone where the transaction originates. |
...
| `coinSelectorCreator` | (`utxos`) => [`FewestCoinSelector`](/jp/sdk/content/classes/FewestCoinSelector) \| `ConversionCoinSelector` | - |
...
`Promise`\<[`QiTransaction`](/jp/sdk/content/classes/QiTransaction)\>
...
| Parameter | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | `undefined` | The zone in which to scan for addresses. |
...
| `amount` | `bigint` | The amount of Qi to send. |
| `originZone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone where the transaction originates. |
| `destinationZone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone where the transaction is sent. |
| `options`? | `QiTransactionOptions` | Optional transaction configuration. |
...
| Parameter | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | `undefined` | The zone in which to sync addresses. |
...
| Type parameter |
| :------ |
| `T` *extends* `AbstractHDWallet`\<[`NeuteredAddressInfo`](/jp/sdk/content/interfaces/NeuteredAddressInfo), `T`\> |
...
| `wordlist`? | [`Wordlist`](/jp/sdk/content/classes/Wordlist) | The wordlist. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `serialized` | [`SerializedQiHDWallet`](/jp/sdk/content/interfaces/SerializedQiHDWallet) | The serialized object representing the state of a QiHDWallet. |

#### Returns

`Promise`\<[`QiHDWallet`](/jp/sdk/content/classes/QiHDWallet)\>
...
| :------ | :------ | :------ |
| `this` | `Object` | The constructor of the HD wallet. |
| `mnemonic` | [`Mnemonic`](/jp/sdk/content/classes/Mnemonic) | The mnemonic. |

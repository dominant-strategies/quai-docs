...
| Parameter | Type |
| :------ | :------ |
| `privateKey` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) |
...
| :------ | :------ | :------ |
| `other` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The other key to compute the shared secret with. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `digest` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The data to sign. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `p0` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The first point to add. |
| `p1` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The second point to add. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `key` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The key to compute the public key for. |
| `compressed`? | `boolean` | Whether to return the compressed public key. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `digest` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) | The data that was signed. |
| `signature` | [`SignatureLike`](/jp/sdk/content/type-aliases/SignatureLike) | The signature of the data. |

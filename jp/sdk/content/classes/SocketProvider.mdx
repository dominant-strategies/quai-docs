...
- [`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider)\<[`WebSocketLike`](/jp/sdk/content/interfaces/WebSocketLike)\>
...
| :------ | :------ | :------ |
| `network`? | [`Networkish`](/jp/sdk/content/type-aliases/Networkish) | The network to connect to. |
| `_options`? | [`JsonRpcApiProviderOptions`](/jp/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the provider. |
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`constructor`](/jp/sdk/content/classes/JsonRpcApiProvider#constructors)
...
If this provider has been destroyed using the [**destroy**](/jp/sdk/content/classes/AbstractProvider#destroy) method.
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`_clearTimeout`](/jp/sdk/content/classes/JsonRpcApiProvider#_cleartimeout)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`destroy`](/jp/sdk/content/classes/JsonRpcApiProvider#destroy)
...
`Promise`\<[`Shard`](/jp/sdk/content/enumerations/Shard)[]\>

A promise that resolves to the active shards.

#### Inherited from

[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getActiveRegions`](/jp/sdk/content/classes/JsonRpcApiProvider#getactiveregions)
...
`Promise`\<[`Zone`](/jp/sdk/content/enumerations/Zone)[]\>

A promise that resolves to the active zones.

#### Inherited from

[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getActiveZones`](/jp/sdk/content/classes/JsonRpcApiProvider#getactivezones)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone to get the rate for. |
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getLatestQiToQuaiRate`](/jp/sdk/content/classes/JsonRpcApiProvider#getlatestqitoquairate)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getLatestQuaiToQiRate`](/jp/sdk/content/classes/JsonRpcApiProvider#getlatestquaitoqirate)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getProtocolExpansionNumber`](/jp/sdk/content/classes/JsonRpcApiProvider#getprotocolexpansionnumber)
...
| :------ | :------ | :------ |
| `zone` | [`Zone`](/jp/sdk/content/enumerations/Zone) | The zone to get the rate for. |
| `blockTag` | [`BlockTag`](/jp/sdk/content/type-aliases/BlockTag) | The block tag to get the rate at. |
| `amt`? | `bigint` | The amount to get the rate for. Default is `1` |
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getQiToQuaiRateAtBlock`](/jp/sdk/content/classes/JsonRpcApiProvider#getqitoquairateatblock)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getQuaiToQiRateAtBlock`](/jp/sdk/content/classes/JsonRpcApiProvider#getquaitoqirateatblock)
...
`Promise`\<[`JsonRpcSigner`](/jp/sdk/content/classes/JsonRpcSigner)\>

A promise that resolves to the JsonRpcSigner.

#### Inherited from

[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`getSigner`](/jp/sdk/content/classes/JsonRpcApiProvider#getsigner)
...
| :------ | :------ |
| `U` | `string`[] \| [`FetchRequest`](/jp/sdk/content/classes/FetchRequest) |
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`initialize`](/jp/sdk/content/classes/JsonRpcApiProvider#initialize)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`listAccounts`](/jp/sdk/content/classes/JsonRpcApiProvider#listaccounts)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`pause`](/jp/sdk/content/classes/JsonRpcApiProvider#pause)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`resume`](/jp/sdk/content/classes/JsonRpcApiProvider#resume)
...
| `shard`? | [`Shard`](/jp/sdk/content/enumerations/Shard) | The shard to send the request to. |
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`send`](/jp/sdk/content/classes/JsonRpcApiProvider#send)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`shardFromHash`](/jp/sdk/content/classes/JsonRpcApiProvider#shardfromhash)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_address` | [`AddressLike`](/jp/sdk/content/type-aliases/AddressLike) | The address to get the zone from. |
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`zoneFromAddress`](/jp/sdk/content/classes/JsonRpcApiProvider#zonefromaddress)
...
[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider).[`zoneFromHash`](/jp/sdk/content/classes/JsonRpcApiProvider#zonefromhash)

...
| :------ | :------ | :------ |
| `key` | `string` \| [`SigningKey`](/jp/sdk/content/classes/SigningKey) | The private key. |
...
| `#signingKey` | `private` | [`SigningKey`](/jp/sdk/content/classes/SigningKey) | The signing key used for signing payloads. | `BaseWallet.#signingKey` |
| `provider` | `readonly` | `null` \| [`Provider`](/jp/sdk/content/interfaces/Provider) | The provider this signer is connected to. | `BaseWallet.provider` |
...
The [**SigningKey**](/jp/sdk/content/classes/SigningKey) used for signing payloads.
...
| `progressCallback`? | [`ProgressCallback`](/jp/sdk/content/type-aliases/ProgressCallback) | An optional callback to keep the user informed. |
...
[**ProgressCallback**](/jp/sdk/content/type-aliases/ProgressCallback) to keep the user informed.
...
| `progress`? | [`ProgressCallback`](/jp/sdk/content/type-aliases/ProgressCallback) | An optional callback to keep the user informed. |

#### Returns

`Promise`\<[`Wallet`](/jp/sdk/content/classes/Wallet)\>
...
The [**fromEncryptedJson**](/jp/sdk/content/classes/Wallet#fromencryptedjson) method is preferred, as this method will lock up and
...
[`QuaiHDWallet`](/jp/sdk/content/classes/QuaiHDWallet) \| [`Wallet`](/jp/sdk/content/classes/Wallet)

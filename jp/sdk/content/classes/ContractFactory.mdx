...
| :------ | :------ |
| `A` *extends* `any`[] | `any`[] |
| `I` | [`BaseContract`](/jp/sdk/content/classes/BaseContract) |
...
| :------ | :------ | :------ |
| `abi` | [`Interface`](/jp/sdk/content/classes/Interface) \| [`InterfaceAbi`](/jp/sdk/content/type-aliases/InterfaceAbi) | `undefined` |
| `bytecode` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) \| \{ `"object"`: `string`; \} | `undefined` |
| `runner`? | `null` \| [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner) | `undefined` |
| `IPFSHash`? | `null` \| `string` | `null` |

#### Returns

[`ContractFactory`](/jp/sdk/content/classes/ContractFactory)\<`A`, `I`\>
...
| `runner` | `readonly` | `null` \| [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner) | The ContractRunner to deploy the Contract as. |
...
| :------ | :------ | :------ |
| `runner` | `null` \| [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner) | The runner to connect to. |
...
`Promise`\<[`BaseContract`](/jp/sdk/content/classes/BaseContract) & \{
  `"deploymentTransaction"`: [`ContractTransactionResponse`](/jp/sdk/content/classes/ContractTransactionResponse);
 \} & `Omit`\<`I`, keyof [`BaseContract`](/jp/sdk/content/classes/BaseContract)\>\>
...
`Promise`\<[`ContractDeployTransaction`](/jp/sdk/content/interfaces/ContractDeployTransaction)\>
...
| :------ | :------ |
| `A` *extends* `any`[] | `any`[] |
| `I` | [`ContractInterface`](/jp/sdk/content/interfaces/ContractInterface) |
...
| `runner`? | [`ContractRunner`](/jp/sdk/content/interfaces/ContractRunner) | The runner to connect to. |

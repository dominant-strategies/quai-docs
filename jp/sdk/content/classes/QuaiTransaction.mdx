...
- `AbstractTransaction`\<[`Signature`](/jp/sdk/content/classes/Signature)\>
...
`null` \| [`AccessList`](/jp/sdk/content/type-aliases/AccessList)
...
`undefined` \| [`Zone`](/jp/sdk/content/enumerations/Zone)
...
[**unsignedSerialized** ](/jp/sdk/content/classes/QiTransaction#unsignedserialized).

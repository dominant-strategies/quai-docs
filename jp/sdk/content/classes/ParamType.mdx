...
Each input and output of a [**Fragment**](/jp/sdk/content/classes/Fragment) is an Array of [**ParamType**](/jp/sdk/content/classes/ParamType).

## Properties

| Property | Modifier | Type | Description |
| :------ | :------ | :------ | :------ |
| `arrayChildren` | `readonly` | `null` \| [`ParamType`](/jp/sdk/content/classes/ParamType) | The type of each child in the array.<br /><br />For non-array types this is `null`. |
...
| `components` | `readonly` | `null` \| readonly [`ParamType`](/jp/sdk/content/classes/ParamType)[] | The components for the tuple.<br /><br />For non-tuple types this is `null`. |
...
This provides a type guard ensuring that [**arrayChildren**](/jp/sdk/content/classes/ParamType) and
[**arrayLength**](/jp/sdk/content/classes/ParamType) are non-null.
...
This provides a type guard ensuring that [**indexed**](/jp/sdk/content/classes/ParamType) is non-null.
...
This provides a type guard ensuring that [**components**](/jp/sdk/content/classes/ParamType) is non-null.
...
| :------ | :------ |
| `value` | `any` |
| `process` | [`ParamTypeWalkFunc`](/jp/sdk/content/type-aliases/ParamTypeWalkFunc) |
...
| :------ | :------ |
| `value` | `any` |
| `process` | [`ParamTypeWalkAsyncFunc`](/jp/sdk/content/type-aliases/ParamTypeWalkAsyncFunc) |

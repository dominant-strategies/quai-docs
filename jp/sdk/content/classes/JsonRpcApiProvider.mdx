...
- [`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider)\<`C`\>
...
| :------ | :------ |
| `C` | [`FetchRequest`](/jp/sdk/content/classes/FetchRequest) |
...
| `options`? | [`JsonRpcApiProviderOptions`](/jp/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the provider. |

#### Returns

[`JsonRpcApiProvider`](/jp/sdk/content/classes/JsonRpcApiProvider)\<`C`\>

#### Overrides

[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`constructor`](/jp/sdk/content/classes/AbstractProvider#constructors)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`_clearTimeout`](/jp/sdk/content/classes/AbstractProvider#_cleartimeout)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`destroy`](/jp/sdk/content/classes/AbstractProvider#destroy)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`getActiveRegions`](/jp/sdk/content/classes/AbstractProvider#getactiveregions)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`getActiveZones`](/jp/sdk/content/classes/AbstractProvider#getactivezones)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`getLatestQiToQuaiRate`](/jp/sdk/content/classes/AbstractProvider#getlatestqitoquairate)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`getLatestQuaiToQiRate`](/jp/sdk/content/classes/AbstractProvider#getlatestquaitoqirate)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`getProtocolExpansionNumber`](/jp/sdk/content/classes/AbstractProvider#getprotocolexpansionnumber)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`getQiToQuaiRateAtBlock`](/jp/sdk/content/classes/AbstractProvider#getqitoquairateatblock)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`getQuaiToQiRateAtBlock`](/jp/sdk/content/classes/AbstractProvider#getquaitoqirateatblock)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`initialize`](/jp/sdk/content/classes/AbstractProvider#initialize)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`pause`](/jp/sdk/content/classes/AbstractProvider#pause)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`resume`](/jp/sdk/content/classes/AbstractProvider#resume)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`shardFromHash`](/jp/sdk/content/classes/AbstractProvider#shardfromhash)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`zoneFromAddress`](/jp/sdk/content/classes/AbstractProvider#zonefromaddress)
...
[`AbstractProvider`](/jp/sdk/content/classes/AbstractProvider).[`zoneFromHash`](/jp/sdk/content/classes/AbstractProvider#zonefromhash)

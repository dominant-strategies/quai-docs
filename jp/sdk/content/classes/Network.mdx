...
| `chainId` | [`BigNumberish`](/jp/sdk/content/type-aliases/BigNumberish) | The network chain ID. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `value` | [`BigNumberish`](/jp/sdk/content/type-aliases/BigNumberish) | The new network chain ID. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `network`? | [`Networkish`](/jp/sdk/content/type-aliases/Networkish) | The network to get. |
...
| `networkFunc` | () => [`Network`](/jp/sdk/content/classes/Network) | The function to create the Network. |

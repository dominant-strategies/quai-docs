...
The ABI can be specified by [any supported format](/jp/sdk/content/type-aliases/InterfaceAbi).
...
| :------ | :------ | :------ |
| `fragments` | [`InterfaceAbi`](/jp/sdk/content/type-aliases/InterfaceAbi) | The ABI fragments. |
...
| :------ | :------ | :------ | :------ |
| `deploy` | `readonly` | [`ConstructorFragment`](/jp/sdk/content/classes/ConstructorFragment) | The Contract constructor. |
| `fallback` | `readonly` | `null` \| [`FallbackFragment`](/jp/sdk/content/classes/FallbackFragment) | The Fallback method, if any. |
| `fragments` | `readonly` | readonly [`Fragment`](/jp/sdk/content/classes/Fragment)[] | All the Contract ABI members (i.e. methods, events, errors, etc). |
...
Decodes the result `data` (e.g. from an `quai_call`) for the specified error (see [**getError**](/jp/sdk/content/classes/Interface#geterror)
...
| Parameter | Type |
| :------ | :------ |
| `fragment` | `string` \| [`ErrorFragment`](/jp/sdk/content/classes/ErrorFragment) |
| `data` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) |
...
[**getFunction**](/jp/sdk/content/classes/Interface#getfunction) for valid values for `fragment`).

Most developers should prefer the [**parseTransaction**](/jp/sdk/content/classes/Interface#parsetransaction) method instead, which will
...
| Parameter | Type |
| :------ | :------ |
| `fragment` | `string` \| [`FunctionFragment`](/jp/sdk/content/classes/FunctionFragment) |
| `data` | [`BytesLike`](/jp/sdk/content/type-aliases/BytesLike) |
...
[**getFunction**](/jp/sdk/content/classes/Interface#getfunction) for valid values for `key`).
...
`error` (see [**getError**](/jp/sdk/content/classes/Interface#geterror) for valid values for `fragment`) with the `values`.
...
[**getFunction**](/jp/sdk/content/classes/Interface#getfunction) for valid values for `fragment`) with the `values`.
...
[**getFunction**](/jp/sdk/content/classes/Interface#getfunction) for valid values for `fragment`) with `values`.
...
Get the [**ErroFragment**](/jp/sdk/content/classes/ErrorFragment) for `key`, which may be an error selector, error name or error
...
`null` \| [`ErrorFragment`](/jp/sdk/content/classes/ErrorFragment)
...
Get the [**EventFragment**](/jp/sdk/content/classes/EventFragment) for `key`, which may be a topic hash, event name or event
signature that belongs to the ABI.
...
`null` \| [`EventFragment`](/jp/sdk/content/classes/EventFragment)
...
Get the [**FunctionFragment**](/jp/sdk/content/classes/FunctionFragment) for `key`, which may be a function selector, function name
...
`null` \| [`FunctionFragment`](/jp/sdk/content/classes/FunctionFragment)
...
[**EventFragment**](/jp/sdk/content/classes/EventFragment) may require refinement.
...
[**FunctionFragment**](/jp/sdk/content/classes/FunctionFragment) may require refinement.
...
`null` \| [`ErrorDescription`](/jp/sdk/content/classes/ErrorDescription)
...
`null` \| [`LogDescription`](/jp/sdk/content/classes/LogDescription)
...
| `tx` | `object` |
| `tx.data` | `string` |
| `tx.value`? | [`BigNumberish`](/jp/sdk/content/type-aliases/BigNumberish) |

#### Returns

`null` \| [`TransactionDescription`](/jp/sdk/content/classes/TransactionDescription)
...
Creates a new [**Interface**](/jp/sdk/content/classes/Interface) from the ABI `value`.

The `value` may be provided as an existing [**Interface**](/jp/sdk/content/classes/Interface) object, a JSON-encoded ABI or any
...
| Parameter | Type |
| :------ | :------ |
| `value` | [`Interface`](/jp/sdk/content/classes/Interface) \| [`InterfaceAbi`](/jp/sdk/content/type-aliases/InterfaceAbi) |

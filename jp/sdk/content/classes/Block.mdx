...
| :------ | :------ | :------ |
| `block` | [`BlockParams`](/jp/sdk/content/interfaces/BlockParams) | The block parameters. |
...
| :------ | :------ | :------ | :------ |
| `provider` | `readonly` | [`Provider`](/jp/sdk/content/interfaces/Provider) | The provider connected to the block used to fetch additional details if necessary. |

...
`Promise`\<`null` \| [`QiTransactionResponse`](/jp/sdk/content/classes/QiTransactionResponse)\>
...
use [**getTransaction**](/jp/sdk/content/classes/QiTransactionResponse#gettransaction).

...
| :------ | :------ | :------ |
| `ethereum` | [`Eip1193Provider`](/jp/sdk/content/interfaces/Eip1193Provider) | The EIP-1193 provider. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `payload` | [`JsonRpcPayload`](/jp/sdk/content/type-aliases/JsonRpcPayload) | The JSON-RPC payload. |
| `error` | [`JsonRpcError`](/jp/sdk/content/type-aliases/JsonRpcError) | The JSON-RPC error. |
...
| `shard`? | [`Shard`](/jp/sdk/content/enumerations/Shard) | - |

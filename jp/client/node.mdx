...
If you're ready to start setting up your node now, check out the [node installation guide](/jp/guides/client/node), or [the video tutorial on the Quai YouTube](https://www.youtube.com/watch?v=eKk8b5-7TMk).

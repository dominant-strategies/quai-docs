...
|                                                   |                                                   |
| ------------------------------------------------- | ------------------------------------------------- |
| [Quai Network Node](/jp/guides/client/node) | A Quai Network node to use as the pool endpoint.  |
| Publicly accessible node | Ensure that port 8200 is publicly accessible to miners. |

## Installation
Please follow the instructions for how to [Run A Node](/jp/guides/client/node) before continuing to the next section.

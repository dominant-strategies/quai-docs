...
<Steps>
  ...
  <Step title="Interact with the contract">
    ...
    To interact with the contract, you can configure a simple script using the [Quais SDK](/jp/sdk/static/contract). The script below configures a [Contract](/jp/sdk/content/classes/Contract) instance for the ERC20 token we deployed to `0x00735E9B2c731Fd3eCC8129a3653ACb99dF969cC` to get the name, symbol, and total supply of the token.

...
- [Learn how to set up a GPU Miner](/participate/mining/gpu-miner/gpu-miner)
- [Learn how to connect a GPU miner to a node with the Stratum Proxy](/participate/stratum-proxy/run-stratum)

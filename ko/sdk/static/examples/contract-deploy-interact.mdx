...
<Warning>
	...
	[Hardhat Deployment Tutorial](/ko/guides/development/solidity).
</Warning>
...
Contracts often have read-only methods (view and pure) that can be called to query the state of the smart contract without initiating a transaction. You can call these methods using only a [Provider](/ko/sdk/content/interfaces/Provider).
...
To call a state-changing method, you'll need to pass a [Signer](/ko/sdk/content/interfaces/Signer) or [Wallet](/ko/sdk/content/interfaces/Wallet) to the contract.
...
To query historic events, you can use the [queryFilter](/ko/sdk/content/classes/Contract#queryfilter) method.

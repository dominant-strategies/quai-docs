...
| `contractAddress` | `null` \| `string` | If the transaction was directly deploying a contract, the [**to**](/ko/sdk/content/interfaces/TransactionReceiptParams) will be<br />null, the `data` will be initcode and if successful, this will be the address of the contract deployed. |
...
| `logs` | readonly [`LogParams`](/ko/sdk/content/interfaces/LogParams)[] | The logs emitted during the execution of this transaction. |

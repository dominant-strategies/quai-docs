...
An Interface to indicate a [**Block**](/ko/sdk/content/classes/Block) has been included in the blockchain. This asserts a Type Guard
...
| :------ | :------ | :------ | :------ | :------ |
| `provider` | `readonly` | [`Provider`](/ko/sdk/content/interfaces/Provider) | The provider connected to the block used to fetch additional details if necessary. | [`Block`](/ko/sdk/content/classes/Block).`provider` |
...
[**getBlock**](/ko/sdk/content/interfaces/Provider#getblock).
...
[`Block`](/ko/sdk/content/classes/Block).[`getExtTransaction`](/ko/sdk/content/classes/Block#getexttransaction)
...
[`Block`](/ko/sdk/content/classes/Block).[`getPrefetchedTransaction`](/ko/sdk/content/classes/Block#getprefetchedtransaction)
...
[`Block`](/ko/sdk/content/classes/Block).[`getTransaction`](/ko/sdk/content/classes/Block#gettransaction)
...
[`Block`](/ko/sdk/content/classes/Block).[`isMined`](/ko/sdk/content/classes/Block#ismined)
...
[`Block`](/ko/sdk/content/classes/Block).[`toJSON`](/ko/sdk/content/classes/Block#tojson)

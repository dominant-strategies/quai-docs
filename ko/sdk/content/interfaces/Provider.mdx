...
Account data includes the [**balance**](/ko/sdk/content/interfaces/Provider#getbalance),
[**getTransactionCount**](/ko/sdk/content/interfaces/Provider#gettransactioncount), [**code**](/ko/sdk/content/interfaces/Provider#getcode) and
[**state trie storage**](/ko/sdk/content/interfaces/Provider#getstorage).

Simulating execution can be used to [**call**](/ko/sdk/content/interfaces/Provider#call), [**estimateGas**](/ko/sdk/content/interfaces/Provider#estimategas)
and [**get transaction result**](/ko/sdk/content/interfaces/Provider#gettransactionresult).

The [**broadcastTransaction**](/ko/sdk/content/interfaces/Provider#broadcasttransaction) is the only method which allows updating the
...
- [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner).[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable)\<[`ProviderEvent`](/ko/sdk/content/type-aliases/ProviderEvent)\>

## Properties

| Property | Type | Description | Overrides | Inherited from |
| :------ | :------ | :------ | :------ | :------ |
| `provider` | [`Provider`](/ko/sdk/content/interfaces/Provider) | The provider iteself.<br /><br />This is part of the necessary API for executing a contract, as it provides a common property on any<br />[**ContractRunner**](/ko/sdk/content/interfaces/ContractRunner) that can be used to access the read-only portion of the runner. | [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner).`provider` | [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner).`provider` |
| `sendTransaction?` | (`tx`: [`TransactionRequest`](/ko/sdk/content/type-aliases/TransactionRequest)) => `Promise`\<[`TransactionResponse`](/ko/sdk/content/type-aliases/TransactionResponse)\> | Required for state mutating calls | [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner).`sendTransaction` | [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner).`sendTransaction` |
...
| Parameter | Type |
| :------ | :------ |
| `event` | [`ProviderEvent`](/ko/sdk/content/type-aliases/ProviderEvent) |
| `listener` | [`Listener`](/ko/sdk/content/type-aliases/Listener) |
| `zone`? | [`Zone`](/ko/sdk/content/enumerations/Zone) |

#### Returns

`Promise`\<[`Provider`](/ko/sdk/content/interfaces/Provider)\>

#### Inherited from

[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`addListener`](/ko/sdk/content/interfaces/EventEmitterable#addlistener)
...
| :------ | :------ | :------ |
| `zone` | [`Zone`](/ko/sdk/content/enumerations/Zone) | The zone to broadcast the transaction to. |
| `signedTx` | `string` | The signed transaction to broadcast. |
| `from`? | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address that signed the transaction. |
...
| `value` | [`BigNumberish`](/ko/sdk/content/type-aliases/BigNumberish) | The amount to convert |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/ko/sdk/content/type-aliases/TransactionRequest) | The transaction to simulate. |
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`emit`](/ko/sdk/content/interfaces/EventEmitterable#emit)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/ko/sdk/content/type-aliases/TransactionRequest) | The transaction to estimate the gas for. |
...
for that `blockTag`, the balance is as of that [**BlockTag**](/ko/sdk/content/type-aliases/BlockTag).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address to fetch the balance for. |
| `blockTag`? | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block tag to fetch the balance from. |
...
included and the [**Block**](/ko/sdk/content/classes/Block) object will not need to make remote calls for getting transactions.
...
| `blockHashOrBlockTag` | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block hash or block tag to fetch. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `shard` | [`Shard`](/ko/sdk/content/enumerations/Shard) | The shard to fetch the block number from. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address to fetch the code for. |
| `blockTag`? | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block tag to fetch the code from. |
...
Get the best guess at the recommended [**FeeData**](/ko/sdk/content/classes/FeeData).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/ko/sdk/content/enumerations/Zone) | The shard to fetch the fee data from. |
| `txType` | `boolean` | The transaction type to fetch the fee data for (true for Quai, false for Qi) |

#### Returns

`Promise`\<[`FeeData`](/ko/sdk/content/classes/FeeData)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address to fetch the locked balance for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `filter` | [`Filter`](/ko/sdk/content/interfaces/Filter) \| [`FilterByBlockHash`](/ko/sdk/content/interfaces/FilterByBlockHash) | The filter to apply. |

#### Returns

`Promise`\<[`Log`](/ko/sdk/content/classes/Log)[]\>
...
Get the connected [**Network**](/ko/sdk/content/classes/Network).

#### Returns

`Promise`\<[`Network`](/ko/sdk/content/classes/Network)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address to fetch the UTXO entries for. |
...
| :------ | :------ | :------ |
| `zone` | [`Zone`](/ko/sdk/content/enumerations/Zone) | - |
| `blockTag` | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | - |
| `amt` | `bigint` | The amount in quais to get the rate for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address to fetch the storage from. |
| `position` | [`BigNumberish`](/ko/sdk/content/type-aliases/BigNumberish) | The position to fetch the storage from. |
| `blockTag`? | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block tag to fetch the storage from. |
...
`Promise`\<`null` \| [`TransactionResponse`](/ko/sdk/content/type-aliases/TransactionResponse) \| `ExternalTransactionResponse`\>
...
of that [**BlockTag**](/ko/sdk/content/type-aliases/BlockTag).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `address` | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address to fetch the transaction count for. |
| `blockTag`? | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block tag to fetch the transaction count from. |
...
`Promise`\<`null` \| [`TransactionReceipt`](/ko/sdk/content/classes/TransactionReceipt)\>
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`listenerCount`](/ko/sdk/content/interfaces/EventEmitterable#listenercount)
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`listeners`](/ko/sdk/content/interfaces/EventEmitterable#listeners)
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`off`](/ko/sdk/content/interfaces/EventEmitterable#off)
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`on`](/ko/sdk/content/interfaces/EventEmitterable#on)
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`once`](/ko/sdk/content/interfaces/EventEmitterable#once)
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`removeAllListeners`](/ko/sdk/content/interfaces/EventEmitterable#removealllisteners)
...
[`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable).[`removeListener`](/ko/sdk/content/interfaces/EventEmitterable#removelistener)
...
| :------ | :------ | :------ |
| `shard` | [`Shard`](/ko/sdk/content/enumerations/Shard) | The shard to fetch the block from. |
| `blockTag`? | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block tag to fetch. |

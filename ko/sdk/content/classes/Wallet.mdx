...
| :------ | :------ | :------ |
| `key` | `string` \| [`SigningKey`](/ko/sdk/content/classes/SigningKey) | The private key. |
...
| `#signingKey` | `private` | [`SigningKey`](/ko/sdk/content/classes/SigningKey) | The signing key used for signing payloads. | `BaseWallet.#signingKey` |
| `provider` | `readonly` | `null` \| [`Provider`](/ko/sdk/content/interfaces/Provider) | The provider this signer is connected to. | `BaseWallet.provider` |
...
The [**SigningKey**](/ko/sdk/content/classes/SigningKey) used for signing payloads.
...
| `progressCallback`? | [`ProgressCallback`](/ko/sdk/content/type-aliases/ProgressCallback) | An optional callback to keep the user informed. |
...
[**ProgressCallback**](/ko/sdk/content/type-aliases/ProgressCallback) to keep the user informed.
...
| `progress`? | [`ProgressCallback`](/ko/sdk/content/type-aliases/ProgressCallback) | An optional callback to keep the user informed. |

#### Returns

`Promise`\<[`Wallet`](/ko/sdk/content/classes/Wallet)\>
...
The [**fromEncryptedJson**](/ko/sdk/content/classes/Wallet#fromencryptedjson) method is preferred, as this method will lock up and
...
[`QuaiHDWallet`](/ko/sdk/content/classes/QuaiHDWallet) \| [`Wallet`](/ko/sdk/content/classes/Wallet)

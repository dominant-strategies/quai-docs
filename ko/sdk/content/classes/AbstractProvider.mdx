...
An **AbstractProvider** provides a base class for other sub-classes to implement the [**Provider**](/ko/sdk/content/interfaces/Provider)
...
discover the [**Network**](/ko/sdk/content/classes/Network) if necessary.

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_network`? | [`Networkish`](/ko/sdk/content/type-aliases/Networkish) | The network to connect to, or `"any"` to |
...
[providers/abstract-provider.ts:826](https://github.com/dominant-strategies/quais.js/blob/c1c12d43f9d34c6baad2b0542bd6d0acd6fefcbf/src/providers/abstract-provider.ts#L826)
...
[`Provider`](/ko/sdk/content/interfaces/Provider).[`destroy`](/ko/sdk/content/interfaces/Provider#destroy)

#### Source

[providers/abstract-provider.ts:2554](https://github.com/dominant-strategies/quais.js/blob/c1c12d43f9d34c6baad2b0542bd6d0acd6fefcbf/src/providers/abstract-provider.ts#L2554)
...
[`Provider`](/ko/sdk/content/interfaces/Provider).[`getLatestQiToQuaiRate`](/ko/sdk/content/interfaces/Provider#getlatestqitoquairate)
...
[`Provider`](/ko/sdk/content/interfaces/Provider).[`getLatestQuaiToQiRate`](/ko/sdk/content/interfaces/Provider#getlatestquaitoqirate)
...
[`Provider`](/ko/sdk/content/interfaces/Provider).[`getProtocolExpansionNumber`](/ko/sdk/content/interfaces/Provider#getprotocolexpansionnumber)
...
[`Provider`](/ko/sdk/content/interfaces/Provider).[`getQiToQuaiRateAtBlock`](/ko/sdk/content/interfaces/Provider#getqitoquairateatblock)
...
[`Provider`](/ko/sdk/content/interfaces/Provider).[`getQuaiToQiRateAtBlock`](/ko/sdk/content/interfaces/Provider#getquaitoqirateatblock)

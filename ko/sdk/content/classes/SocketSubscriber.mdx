...
[**_emit**](/ko/sdk/content/classes/SocketSubscriber#_emit) to manage the events.
...
| :------ | :------ | :------ |
| `provider` | [`SocketProvider`](/ko/sdk/content/classes/SocketProvider) | The socket provider. |
...
[`Subscriber`](/ko/sdk/content/interfaces/Subscriber).[`pause`](/ko/sdk/content/interfaces/Subscriber#pause)
...
[`Subscriber`](/ko/sdk/content/interfaces/Subscriber).[`resume`](/ko/sdk/content/interfaces/Subscriber#resume)
...
[`Subscriber`](/ko/sdk/content/interfaces/Subscriber).[`start`](/ko/sdk/content/interfaces/Subscriber#start)
...
[`Subscriber`](/ko/sdk/content/interfaces/Subscriber).[`stop`](/ko/sdk/content/interfaces/Subscriber#stop)

...
- [`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider)\<`C`\>
...
| :------ | :------ |
| `C` | [`FetchRequest`](/ko/sdk/content/classes/FetchRequest) |
...
| `options`? | [`JsonRpcApiProviderOptions`](/ko/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the provider. |

#### Returns

[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider)\<`C`\>

#### Overrides

[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`constructor`](/ko/sdk/content/classes/AbstractProvider#constructors)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`_clearTimeout`](/ko/sdk/content/classes/AbstractProvider#_cleartimeout)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`destroy`](/ko/sdk/content/classes/AbstractProvider#destroy)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`getActiveRegions`](/ko/sdk/content/classes/AbstractProvider#getactiveregions)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`getActiveZones`](/ko/sdk/content/classes/AbstractProvider#getactivezones)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`getLatestQiToQuaiRate`](/ko/sdk/content/classes/AbstractProvider#getlatestqitoquairate)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`getLatestQuaiToQiRate`](/ko/sdk/content/classes/AbstractProvider#getlatestquaitoqirate)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`getProtocolExpansionNumber`](/ko/sdk/content/classes/AbstractProvider#getprotocolexpansionnumber)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`getQiToQuaiRateAtBlock`](/ko/sdk/content/classes/AbstractProvider#getqitoquairateatblock)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`getQuaiToQiRateAtBlock`](/ko/sdk/content/classes/AbstractProvider#getquaitoqirateatblock)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`initialize`](/ko/sdk/content/classes/AbstractProvider#initialize)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`pause`](/ko/sdk/content/classes/AbstractProvider#pause)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`resume`](/ko/sdk/content/classes/AbstractProvider#resume)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`shardFromHash`](/ko/sdk/content/classes/AbstractProvider#shardfromhash)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`zoneFromAddress`](/ko/sdk/content/classes/AbstractProvider#zonefromaddress)
...
[`AbstractProvider`](/ko/sdk/content/classes/AbstractProvider).[`zoneFromHash`](/ko/sdk/content/classes/AbstractProvider#zonefromhash)

...
The ABI can be specified by [any supported format](/ko/sdk/content/type-aliases/InterfaceAbi).
...
| :------ | :------ | :------ |
| `fragments` | [`InterfaceAbi`](/ko/sdk/content/type-aliases/InterfaceAbi) | The ABI fragments. |
...
| :------ | :------ | :------ | :------ |
| `deploy` | `readonly` | [`ConstructorFragment`](/ko/sdk/content/classes/ConstructorFragment) | The Contract constructor. |
| `fallback` | `readonly` | `null` \| [`FallbackFragment`](/ko/sdk/content/classes/FallbackFragment) | The Fallback method, if any. |
| `fragments` | `readonly` | readonly [`Fragment`](/ko/sdk/content/classes/Fragment)[] | All the Contract ABI members (i.e. methods, events, errors, etc). |
...
Decodes the result `data` (e.g. from an `quai_call`) for the specified error (see [**getError**](/ko/sdk/content/classes/Interface#geterror)
...
| Parameter | Type |
| :------ | :------ |
| `fragment` | `string` \| [`ErrorFragment`](/ko/sdk/content/classes/ErrorFragment) |
| `data` | [`BytesLike`](/ko/sdk/content/type-aliases/BytesLike) |
...
[**getFunction**](/ko/sdk/content/classes/Interface#getfunction) for valid values for `fragment`).

Most developers should prefer the [**parseTransaction**](/ko/sdk/content/classes/Interface#parsetransaction) method instead, which will
...
| Parameter | Type |
| :------ | :------ |
| `fragment` | `string` \| [`FunctionFragment`](/ko/sdk/content/classes/FunctionFragment) |
| `data` | [`BytesLike`](/ko/sdk/content/type-aliases/BytesLike) |
...
[**getFunction**](/ko/sdk/content/classes/Interface#getfunction) for valid values for `key`).
...
`error` (see [**getError**](/ko/sdk/content/classes/Interface#geterror) for valid values for `fragment`) with the `values`.
...
[**getFunction**](/ko/sdk/content/classes/Interface#getfunction) for valid values for `fragment`) with the `values`.
...
[**getFunction**](/ko/sdk/content/classes/Interface#getfunction) for valid values for `fragment`) with `values`.
...
Get the [**ErroFragment**](/ko/sdk/content/classes/ErrorFragment) for `key`, which may be an error selector, error name or error
...
`null` \| [`ErrorFragment`](/ko/sdk/content/classes/ErrorFragment)
...
Get the [**EventFragment**](/ko/sdk/content/classes/EventFragment) for `key`, which may be a topic hash, event name or event
signature that belongs to the ABI.
...
`null` \| [`EventFragment`](/ko/sdk/content/classes/EventFragment)
...
Get the [**FunctionFragment**](/ko/sdk/content/classes/FunctionFragment) for `key`, which may be a function selector, function name
...
`null` \| [`FunctionFragment`](/ko/sdk/content/classes/FunctionFragment)
...
[**EventFragment**](/ko/sdk/content/classes/EventFragment) may require refinement.
...
[**FunctionFragment**](/ko/sdk/content/classes/FunctionFragment) may require refinement.
...
`null` \| [`ErrorDescription`](/ko/sdk/content/classes/ErrorDescription)
...
`null` \| [`LogDescription`](/ko/sdk/content/classes/LogDescription)
...
| `tx` | `object` |
| `tx.data` | `string` |
| `tx.value`? | [`BigNumberish`](/ko/sdk/content/type-aliases/BigNumberish) |

#### Returns

`null` \| [`TransactionDescription`](/ko/sdk/content/classes/TransactionDescription)
...
Creates a new [**Interface**](/ko/sdk/content/classes/Interface) from the ABI `value`.

The `value` may be provided as an existing [**Interface**](/ko/sdk/content/classes/Interface) object, a JSON-encoded ABI or any
...
| Parameter | Type |
| :------ | :------ |
| `value` | [`Interface`](/ko/sdk/content/classes/Interface) \| [`InterfaceAbi`](/ko/sdk/content/type-aliases/InterfaceAbi) |

...
- [`EventEmitterable`](/ko/sdk/content/interfaces/EventEmitterable)\<[`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName)\>

## Properties

| Property | Modifier | Type | Description |
| :------ | :------ | :------ | :------ |
| `fallback` | `readonly` | `null` \| [`WrappedFallback`](/ko/sdk/content/interfaces/WrappedFallback) | The fallback or receive function if any. |
| `filters` | `readonly` | `Record`\<`string`, [`ContractEvent`](/ko/sdk/content/interfaces/ContractEvent)\<`any`[]\>\> | All the Events available on this contract. |
| `interface` | `readonly` | [`Interface`](/ko/sdk/content/classes/Interface) | The contract Interface. |
| `runner` | `readonly` | `null` \| [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner) | The connected runner. This is generally a [**Provider**](../interfaces/Provider) or a<br />[**Signer**](../interfaces/Signer), which dictates what operations are supported.<br /><br />For example, a **Contract** connected to a [**Provider**](../interfaces/Provider) may only execute read-only<br />operations. |
| `target` | `readonly` | `string` \| [`Addressable`](/ko/sdk/content/interfaces/Addressable) | The target to connect to.<br /><br />This can be an address or any [Addressable](../interfaces/Addressable), such as another contract. To get the<br />resolved address, use the `getAddress` method. |
...
Alias for [**on**](/ko/sdk/content/classes/BaseContract#on).

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName) | The event to listen for. |
| `listener` | [`Listener`](/ko/sdk/content/type-aliases/Listener) | The listener to call when the event is emitted. |

#### Returns

`Promise`\<[`BaseContract`](/ko/sdk/content/classes/BaseContract)\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `target` | `string` \| [`Addressable`](/ko/sdk/content/interfaces/Addressable) | The target to connect to. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `runner` | `null` \| [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner) | The runner to use. |
...
`null` \| [`ContractTransactionResponse`](/ko/sdk/content/classes/ContractTransactionResponse)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName) | The event to emit. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `key` | `string` \| [`EventFragment`](/ko/sdk/content/classes/EventFragment) | The name of the event to return. |

#### Returns

[`ContractEvent`](/ko/sdk/content/interfaces/ContractEvent)\<`any`[]\>
...
| :------ | :------ |
| `T` *extends* [`ContractMethod`](/ko/sdk/content/interfaces/ContractMethod)\<`any`[], `any`, `any`, `T`\> | [`ContractMethod`](/ko/sdk/content/interfaces/ContractMethod)\<`any`[], `any`, `any`\> |

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `key` | `string` \| [`FunctionFragment`](/ko/sdk/content/classes/FunctionFragment) | The name of the function to return. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event`? | [`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName) | The event to count listeners for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event`? | [`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName) | The event to get listeners for. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName) | The event to remove the listener from. |
| `listener`? | [`Listener`](/ko/sdk/content/type-aliases/Listener) | The listener to remove. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event` | [`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName) | The event to query. |
| `fromBlock`? | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block to start querying from. |
| `toBlock`? | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block to stop querying at. |

#### Returns

`Promise`\<([`EventLog`](/ko/sdk/content/classes/EventLog) \| [`Log`](/ko/sdk/content/classes/Log))[]\>
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `event`? | [`ContractEventName`](/ko/sdk/content/type-aliases/ContractEventName) | The event to remove the listeners from. |
...
Alias for [**off**](/ko/sdk/content/classes/BaseContract#off).
...
| Type parameter | Value |
| :------ | :------ |
| `T` | [`ContractInterface`](/ko/sdk/content/interfaces/ContractInterface) |

#### Parameters

| Parameter | Type | Description |
| :------ | :------ | :------ |
| `abi` | [`Interface`](/ko/sdk/content/classes/Interface) \| [`InterfaceAbi`](/ko/sdk/content/type-aliases/InterfaceAbi) | The ABI to create the class from. |
...
| `abi` | [`Interface`](/ko/sdk/content/classes/Interface) \| [`InterfaceAbi`](/ko/sdk/content/type-aliases/InterfaceAbi) | The ABI to use. |
| `runner`? | `null` \| [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner) | The runner to use. |

#### Returns

[`BaseContract`](/ko/sdk/content/classes/BaseContract) & `Omit`\<`T`, keyof [`BaseContract`](/ko/sdk/content/classes/BaseContract)\>

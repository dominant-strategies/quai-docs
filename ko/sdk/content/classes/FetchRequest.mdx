...
Additional schemes can be added globally using [**registerGateway**](/ko/sdk/content/classes/FetchRequest#registergateway).
...
[**registerGetUrl**](/ko/sdk/content/classes/FetchRequest#registergeturl). If this has been set, setting is to `null` will cause this
...
`null` \| [`FetchPreflightFunc`](/ko/sdk/content/type-aliases/FetchPreflightFunc)
...
[**FetchResponse.throwThrottleError**](/ko/sdk/content/classes/FetchResponse#throwthrottleerror).

#### Returns

`null` \| [`FetchProcessFunc`](/ko/sdk/content/type-aliases/FetchProcessFunc)
...
`null` \| [`FetchRetryFunc`](/ko/sdk/content/type-aliases/FetchRetryFunc)
...
[**send**](/ko/sdk/content/classes/FetchRequest#send).
...
Returns a new [**FetchRequest**](/ko/sdk/content/classes/FetchRequest) that represents the redirection to `location`.
...
`null` \| [`FetchGatewayFunc`](/ko/sdk/content/type-aliases/FetchGatewayFunc)
...
If [**lockConfig**](/ko/sdk/content/classes/FetchRequest#lockconfig) has been called, no change is made and this throws.
...
| `func` | [`FetchGatewayFunc`](/ko/sdk/content/type-aliases/FetchGatewayFunc) | The gateway function to use. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `getUrl` | [`FetchGetUrlFunc`](/ko/sdk/content/type-aliases/FetchGetUrlFunc) | The function to use for fetching HTTP and HTTPS URIs. |

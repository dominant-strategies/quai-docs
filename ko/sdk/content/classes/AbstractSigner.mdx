...
An **AbstractSigner** includes most of teh functionality required to get a [**Signer**](/ko/sdk/content/interfaces/Signer) working as
...
| :------ | :------ |
| `P` *extends* `null` \| [`Provider`](/ko/sdk/content/interfaces/Provider) | `null` \| [`Provider`](/ko/sdk/content/interfaces/Provider) |
...
[`AbstractSigner`](/ko/sdk/content/classes/AbstractSigner)\<`P`\>
...
[`Signer`](/ko/sdk/content/interfaces/Signer).[`connect`](/ko/sdk/content/interfaces/Signer#connect)
...
[`Signer`](/ko/sdk/content/interfaces/Signer).[`getAddress`](/ko/sdk/content/interfaces/Signer#getaddress)

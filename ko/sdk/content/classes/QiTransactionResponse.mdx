...
`Promise`\<`null` \| [`QiTransactionResponse`](/ko/sdk/content/classes/QiTransactionResponse)\>
...
use [**getTransaction**](/ko/sdk/content/classes/QiTransactionResponse#gettransaction).

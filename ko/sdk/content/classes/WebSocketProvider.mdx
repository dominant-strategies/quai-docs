...
| :------ | :------ | :------ |
| `url` | `string` \| `string`[] \| [`WebSocketLike`](/ko/sdk/content/interfaces/WebSocketLike) \| [`WebSocketCreator`](/ko/sdk/content/type-aliases/WebSocketCreator) | The URL(s) or WebSocket object or creator. |
| `network`? | [`Networkish`](/ko/sdk/content/type-aliases/Networkish) | The network to connect to. |
| `options`? | [`JsonRpcApiProviderOptions`](/ko/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the JSON-RPC API provider. |
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`constructor`](/ko/sdk/content/classes/SocketProvider#constructors)
...
| :------ | :------ | :------ | :------ |
| `readyMap` | `Map`\<[`Shard`](/ko/sdk/content/enumerations/Shard), `boolean`\> | `...` | A map to track the readiness of each shard. |
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`_clearTimeout`](/ko/sdk/content/classes/SocketProvider#_cleartimeout)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`destroy`](/ko/sdk/content/classes/SocketProvider#destroy)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getActiveRegions`](/ko/sdk/content/classes/SocketProvider#getactiveregions)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getActiveZones`](/ko/sdk/content/classes/SocketProvider#getactivezones)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getLatestQiToQuaiRate`](/ko/sdk/content/classes/SocketProvider#getlatestqitoquairate)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getLatestQuaiToQiRate`](/ko/sdk/content/classes/SocketProvider#getlatestquaitoqirate)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getProtocolExpansionNumber`](/ko/sdk/content/classes/SocketProvider#getprotocolexpansionnumber)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getQiToQuaiRateAtBlock`](/ko/sdk/content/classes/SocketProvider#getqitoquairateatblock)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getQuaiToQiRateAtBlock`](/ko/sdk/content/classes/SocketProvider#getquaitoqirateatblock)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`getSigner`](/ko/sdk/content/classes/SocketProvider#getsigner)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`listAccounts`](/ko/sdk/content/classes/SocketProvider#listaccounts)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`pause`](/ko/sdk/content/classes/SocketProvider#pause)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`resume`](/ko/sdk/content/classes/SocketProvider#resume)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`send`](/ko/sdk/content/classes/SocketProvider#send)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`shardFromHash`](/ko/sdk/content/classes/SocketProvider#shardfromhash)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `shard` | [`Shard`](/ko/sdk/content/enumerations/Shard) | The shard identifier. |
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`zoneFromAddress`](/ko/sdk/content/classes/SocketProvider#zonefromaddress)
...
[`SocketProvider`](/ko/sdk/content/classes/SocketProvider).[`zoneFromHash`](/ko/sdk/content/classes/SocketProvider#zonefromhash)

...
- [`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider)\<[`WebSocketLike`](/ko/sdk/content/interfaces/WebSocketLike)\>
...
| :------ | :------ | :------ |
| `network`? | [`Networkish`](/ko/sdk/content/type-aliases/Networkish) | The network to connect to. |
| `_options`? | [`JsonRpcApiProviderOptions`](/ko/sdk/content/type-aliases/JsonRpcApiProviderOptions) | The options for the provider. |
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`constructor`](/ko/sdk/content/classes/JsonRpcApiProvider#constructors)
...
If this provider has been destroyed using the [**destroy**](/ko/sdk/content/classes/AbstractProvider#destroy) method.
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`_clearTimeout`](/ko/sdk/content/classes/JsonRpcApiProvider#_cleartimeout)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`destroy`](/ko/sdk/content/classes/JsonRpcApiProvider#destroy)
...
`Promise`\<[`Shard`](/ko/sdk/content/enumerations/Shard)[]\>

A promise that resolves to the active shards.

#### Inherited from

[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getActiveRegions`](/ko/sdk/content/classes/JsonRpcApiProvider#getactiveregions)
...
`Promise`\<[`Zone`](/ko/sdk/content/enumerations/Zone)[]\>

A promise that resolves to the active zones.

#### Inherited from

[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getActiveZones`](/ko/sdk/content/classes/JsonRpcApiProvider#getactivezones)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `zone` | [`Zone`](/ko/sdk/content/enumerations/Zone) | The zone to get the rate for. |
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getLatestQiToQuaiRate`](/ko/sdk/content/classes/JsonRpcApiProvider#getlatestqitoquairate)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getLatestQuaiToQiRate`](/ko/sdk/content/classes/JsonRpcApiProvider#getlatestquaitoqirate)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getProtocolExpansionNumber`](/ko/sdk/content/classes/JsonRpcApiProvider#getprotocolexpansionnumber)
...
| :------ | :------ | :------ |
| `zone` | [`Zone`](/ko/sdk/content/enumerations/Zone) | The zone to get the rate for. |
| `blockTag` | [`BlockTag`](/ko/sdk/content/type-aliases/BlockTag) | The block tag to get the rate at. |
| `amt`? | `bigint` | The amount to get the rate for. Default is `1` |
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getQiToQuaiRateAtBlock`](/ko/sdk/content/classes/JsonRpcApiProvider#getqitoquairateatblock)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getQuaiToQiRateAtBlock`](/ko/sdk/content/classes/JsonRpcApiProvider#getquaitoqirateatblock)
...
`Promise`\<[`JsonRpcSigner`](/ko/sdk/content/classes/JsonRpcSigner)\>

A promise that resolves to the JsonRpcSigner.

#### Inherited from

[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`getSigner`](/ko/sdk/content/classes/JsonRpcApiProvider#getsigner)
...
| :------ | :------ |
| `U` | `string`[] \| [`FetchRequest`](/ko/sdk/content/classes/FetchRequest) |
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`initialize`](/ko/sdk/content/classes/JsonRpcApiProvider#initialize)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`listAccounts`](/ko/sdk/content/classes/JsonRpcApiProvider#listaccounts)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`pause`](/ko/sdk/content/classes/JsonRpcApiProvider#pause)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`resume`](/ko/sdk/content/classes/JsonRpcApiProvider#resume)
...
| `shard`? | [`Shard`](/ko/sdk/content/enumerations/Shard) | The shard to send the request to. |
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`send`](/ko/sdk/content/classes/JsonRpcApiProvider#send)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`shardFromHash`](/ko/sdk/content/classes/JsonRpcApiProvider#shardfromhash)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `_address` | [`AddressLike`](/ko/sdk/content/type-aliases/AddressLike) | The address to get the zone from. |
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`zoneFromAddress`](/ko/sdk/content/classes/JsonRpcApiProvider#zonefromaddress)
...
[`JsonRpcApiProvider`](/ko/sdk/content/classes/JsonRpcApiProvider).[`zoneFromHash`](/ko/sdk/content/classes/JsonRpcApiProvider#zonefromhash)

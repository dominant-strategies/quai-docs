...
| :------ | :------ |
| `A` *extends* `any`[] | `any`[] |
| `I` | [`BaseContract`](/ko/sdk/content/classes/BaseContract) |
...
| :------ | :------ | :------ |
| `abi` | [`Interface`](/ko/sdk/content/classes/Interface) \| [`InterfaceAbi`](/ko/sdk/content/type-aliases/InterfaceAbi) | `undefined` |
| `bytecode` | [`BytesLike`](/ko/sdk/content/type-aliases/BytesLike) \| \{ `"object"`: `string`; \} | `undefined` |
| `runner`? | `null` \| [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner) | `undefined` |
| `IPFSHash`? | `null` \| `string` | `null` |

#### Returns

[`ContractFactory`](/ko/sdk/content/classes/ContractFactory)\<`A`, `I`\>
...
| `runner` | `readonly` | `null` \| [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner) | The ContractRunner to deploy the Contract as. |
...
| :------ | :------ | :------ |
| `runner` | `null` \| [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner) | The runner to connect to. |
...
`Promise`\<[`BaseContract`](/ko/sdk/content/classes/BaseContract) & \{
  `"deploymentTransaction"`: [`ContractTransactionResponse`](/ko/sdk/content/classes/ContractTransactionResponse);
 \} & `Omit`\<`I`, keyof [`BaseContract`](/ko/sdk/content/classes/BaseContract)\>\>
...
`Promise`\<[`ContractDeployTransaction`](/ko/sdk/content/interfaces/ContractDeployTransaction)\>
...
| :------ | :------ |
| `A` *extends* `any`[] | `any`[] |
| `I` | [`ContractInterface`](/ko/sdk/content/interfaces/ContractInterface) |
...
| `runner`? | [`ContractRunner`](/ko/sdk/content/interfaces/ContractRunner) | The runner to connect to. |

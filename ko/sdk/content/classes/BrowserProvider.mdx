...
| :------ | :------ | :------ |
| `ethereum` | [`Eip1193Provider`](/ko/sdk/content/interfaces/Eip1193Provider) | The EIP-1193 provider. |
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `payload` | [`JsonRpcPayload`](/ko/sdk/content/type-aliases/JsonRpcPayload) | The JSON-RPC payload. |
| `error` | [`JsonRpcError`](/ko/sdk/content/type-aliases/JsonRpcError) | The JSON-RPC error. |
...
| `shard`? | [`Shard`](/ko/sdk/content/enumerations/Shard) | - |

...
A **ProviderEvent** provides the types of events that can be subscribed to on a [**Provider**](/ko/sdk/content/interfaces/Provider).
...
[**EventFilter**](/ko/sdk/content/interfaces/EventFilter) - calls the listener with each matching log

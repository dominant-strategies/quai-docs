...
| `progress`? | [`ProgressCallback`](/ko/sdk/content/type-aliases/ProgressCallback) | The callback to receive progress updates. |

## Returns

`Promise`\<[`KeystoreAccount`](/ko/sdk/content/type-aliases/KeystoreAccount)\>

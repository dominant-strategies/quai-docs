...
| `_salt` | [`BytesLike`](/ko/sdk/content/type-aliases/BytesLike) | The salt value. |
| `_initCodeHash` | [`BytesLike`](/ko/sdk/content/type-aliases/BytesLike) | The hash of the init code. |

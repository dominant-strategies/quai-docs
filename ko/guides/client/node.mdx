...
<Steps>
  ...
  <Step title="Block Reward Prefernce">
    The Quai protocol can payout block rewards and miner tips in either [Quai](/ko/learn/tokenomics/quai-emissions) or [Qi](/ko/learn/tokenomics/qi-emissions) tokens. While miners have no ability to determine what token their miner tips are paid out in, the do have the ability to set their block reward payout token preference to either Quai or Qi.
  ...
  <Step title="Slices">
    ...
    In the codebase, a slice is identified by its [region and zone index](/ko/client/node#networking-and-conventions). Region and zone indices are 0-indexed and range from 0-2.

...
<AccordionGroup>
  ...
  <Accordion title="API Methods and Namespace">
    The [Go-Quai client API](/ko/build/playground/introduction) closely resembles
  ...
  <Accordion title="Interoperability Opcodes">
    ...
    [Solidity](/ko/build/smart-contracts/solidity) smart contracts.
  </Accordion>
...
<CardGroup>
  ...
  <Card title="Local Node Runner" icon="terminal" href="/ko/guides/client/containerized-node">

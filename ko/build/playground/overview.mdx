...
|                                                 |                                                                                  |
| ----------------------------------------------- | -------------------------------------------------------------------------------- |
| [Quais SDK](/ko/sdk/introduction)                  | A complete Quai Network interaction library for JavaScript and TypeScript.       |
| [Quai Postman Collection](/ko/build/apis/postman/) | A collection of API requests for Quai Network that can be imported into Postman. |
...
Each zone chain within Quai Network maintains a unique, local set of data. Each address, contract, and transaction made on the network "lives" in a specific zone chain, or a [sharded state](/ko/learn/advanced-introduction/hierarchical-structure/sharding). A general understanding of this concept is required to effectively use the JSON RPC API to query data and interact with the network.

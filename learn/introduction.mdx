...
<CardGroup cols={1}>
  <Card title="Orchard Testnet" icon="microchip">
    Quai Network's official testnet. Developers can use this testnet to build
    and test their applications before deploying to Mainnet.
  </Card>
</CardGroup>

<CardGroup cols={1}>
  <Card title="Golden Age Testnet" icon="pickaxe">
    Concluded on January 15, 2025. Golden Age was the final testnet before
    Mainnet launch.
  </Card>
</CardGroup>

Read more about these networks and the features they support [here](/build/networks).

...
The starting point for the calculation of entropy change is the bits of entropy removed from a block. This is computed using a measure of [intrinsic block weight](/learn/advanced-introduction/poem/fork-choice/intrinsic-block-weight).

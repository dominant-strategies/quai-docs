...
This design means most transactions will require inputs from both parties making the default behavior look like a 2 person coinjoin. 

Together, **enforced non-address reuse**, **payment codes**, and **fixed denominations** make QI transactions **effectively untraceable**.

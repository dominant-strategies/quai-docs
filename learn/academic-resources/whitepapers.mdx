...
## Quai Network: Reignite The Crypto Revolution (Litepaper)

**Published 10 October 2024**

A highlevel overview of the first decentralized energy dollar on the only scalable and programmable Proof-of-Work blockchain.

Read the full litepaper on [qu.ai](https://qu.ai/litepaper)
...
Read the full paper on [arxiv.org](https://arxiv.org/abs/2503.10185).

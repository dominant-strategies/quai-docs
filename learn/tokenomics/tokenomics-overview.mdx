...
## SOAP: Making It All Sustainable

SOAP turns merge-mining rewards into continuous QUAI **buyback and burn**.

How it works:
1. Merge-mined rewards flow into SOAP
2. SOAP buys QUAI on the open market
3. Purchased QUAI is burned (100%)

The result is a built-in sink for supply that can help offset emissions.

<Frame>
	<img src='/images/Tokenomics/SOAPBuybackFlow.png' />
</Frame>

For the broader supply story, see [Quai Emissions](/learn/tokenomics/quai-emissions) and [SOAP](/learn/advanced-introduction/soap).

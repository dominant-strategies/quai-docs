...
There are a variety of dynamics between the [Quai](/learn/tokenomics/quai-emissions) and [Qi](/learn/tokenomics/qi-emissions) tokens that position Quai as an [increasingly-scarce store-of-value](/learn/tokenomics/quai-emissions), and Qi as a medium of exchange, loosely tied to the cost of generating a hash (and thus the cost of energy).
...
When demand for Qi falls, arbitrageurs can swap natively from Qi to Quai at the current conversion ratio, reducing the supply of Qi. When demand for Qi rises, more miners will be incentivized to accept their block rewards in Qi rather than Quai, increasing the supply of Qi. The conversion dynamic is explored more in-depth in the [conversions page](/learn/tokenomics/token-dynamics/conversions) of the documentation.

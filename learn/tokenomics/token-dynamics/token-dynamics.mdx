...
There are a variety of dynamics between the [Quai](/learn/tokenomics/tokenomics-overview/quai) and [Qi](/learn/tokenomics/tokenomics-overview/qi) tokens that position Quai as an [increasingly-scarce store-of-value](/learn/tokenomics/token-dynamics/supply-growth), and Qi as a medium of exchange, loosely tied to the cost of generating a hash (and thus the cost of energy).

...
Note that there is a proportionality constant/variable in the Qi [block reward](/learn/tokenomics/token-dynamics/block-rewards/block-rewards) function above, which is currently set to $2.6 \times 10^9$. This variable may be changed closer to the official launch of Qi.

...
**2. Token Conversions:**
Anyone can convert between Qi and Quai at the current mining reward ratio - not just miners. This [conversion mechanism](/learn/tokenomics/token-dynamics/conversions) allows the market to fine-tune supply based on actual utility demand.

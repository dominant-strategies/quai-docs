...
| [Metamask Snap](/guides/wallet/metamask-snap) | Browser Extension | Metamask Snap | Available for $QUAI only |
| [Tangem](https://tangem.com) | Hardware Wallet | Physical card wallet | Available for $QUAI only |
| [Quai CLI Wallet](https://github.com/dominant-strategies/quai-cli-wallet/releases) | Command Line Wallet | Linux and MacOS Supported | Available for $QUAI only |

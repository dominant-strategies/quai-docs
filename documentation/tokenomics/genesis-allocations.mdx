...
<Note>
	Further information about these allocation groupings, details and vesting/unlock schedules will be made available during upcoming
	Testnets, ahead of Quai Network's Mainnet launch.
</Note>

A pre-allotted amount of 3 billion Quai will be generated as part of the genesis block.

![Genesis Quai Distributions](/images/Tokenomics/GenesisQuaiDistribution.png)

...
[quais6](../globals.md) / FixedFormat

# Type alias: FixedFormat

> **FixedFormat**: `number` \| `string` \| `object`
...
[src.ts/utils/fixednumber.ts:87](https://github.com/dominant-strategies/quais-6.js/blob/aca1855329c3946c627ab7f16ac5304cea7d20c5/src.ts/utils/fixednumber.ts#L87)

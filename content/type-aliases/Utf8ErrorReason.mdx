...
description: When using the UTF-8 error API the following errors can be
  intercepted  and processed as the ...
---
...
When using the UTF-8 error API the following errors can be intercepted
 and processed as the `reason` passed to the [**Utf8ErrorFunc**](/content/type-aliases/Utf8ErrorFunc.mdx).
...
[src.ts/utils/utf8.ts:55](https://github.com/dominant-strategies/quais-6.js/blob/3f482dd134064d41657ff7dc9ba8162f741c9c83/src.ts/utils/utf8.ts#L55)

...
- [`Addressable`](/content/interfaces/Addressable).[`ContractRunner`](/content/interfaces/ContractRunner)

## Properties

| Property | Type | Description | Overrides |
| :------ | :------ | :------ | :------ |
| `provider` | `null` \| [`Provider`](/content/interfaces/Provider) | The [**Provider**](/content/interfaces/Provider) attached to this Signer (if any). | [`ContractRunner`](/content/interfaces/ContractRunner).`provider` |
...
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/content/type-aliases/TransactionRequest) | The transaction to call. |
...
[src/signers/signer.ts:122](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L122)
...
[src/signers/signer.ts:31](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L31)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/content/type-aliases/TransactionRequest) | The transaction to estimate gas for. |
...
[src/signers/signer.ts:109](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L109)
...
[src/signers/signer.ts:42](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L42)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `blockTag`? | [`BlockTag`](/content/type-aliases/BlockTag) | The blocktag to base the transaction count on, keep in mind many nodes do not honour this value<br />  and silently ignore it [default: `"latest"`] |
...
[src/signers/signer.ts:52](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L52)
...
Prepares a [TransactionRequest](/content/type-aliases/TransactionRequest) for calling:
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/content/type-aliases/TransactionRequest) | The call to prepare |

#### Returns

`Promise`\<[`TransactionLike`](/content/interfaces/TransactionLike)\>

A promise resolving to the prepared transaction.

#### Source

[src/signers/signer.ts:67](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L67)
...
Prepares a [TransactionRequest](/content/type-aliases/TransactionRequest) for sending to the network by populating any missing properties:
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/content/type-aliases/TransactionRequest) | The transaction to prepare. |
...
[src/signers/signer.ts:88](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L88)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/content/type-aliases/TransactionRequest) | The transaction to send. |
...
[src/signers/signer.ts:147](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L147)
...
[src/signers/signer.ts:162](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L162)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `tx` | [`TransactionRequest`](/content/type-aliases/TransactionRequest) | The transaction to sign. |
...
[src/signers/signer.ts:136](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L136)
...
[src/signers/signer.ts:173](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/signers/signer.ts#L173)

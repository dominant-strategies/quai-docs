---
title: JsonFragment
description: A fragment for a method, event or error in a [JSON ABI
...
| `inputs?` | `readonly` | readonly [`JsonFragmentType`](/content/interfaces/JsonFragmentType.mdx)[] | The input parameters. |
| `name?` | `readonly` | `string` | The name of the error, event, function, etc. |
| `outputs?` | `readonly` | readonly [`JsonFragmentType`](/content/interfaces/JsonFragmentType.mdx)[] | The output parameters. |

---
title: LogParams
description: a **LogParams** encodes the minimal required properties for
  a  formatted log....
---
...
| `blockHash` | `string` | The block hash of the block that included the transaction for this<br /> log. |
| `blockNumber` | `number` | The block number of the block that included the transaction for this<br /> log. |
| `data` | `string` | The data emitted with this log. |
| `index` | `number` | The index of this log. |
| `removed` | `boolean` | Whether this log was removed due to the transaction it was included<br /> in being removed dur to an orphaned block. |

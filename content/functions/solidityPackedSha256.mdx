...
[quais6](../globals.md) / solidityPackedSha256

# Function: solidityPackedSha256()

> **solidityPackedSha256**(`types`, `values`): `string`
...
[src.ts/hash/solidity.ts:139](https://github.com/dominant-strategies/quais-6.js/blob/aca1855329c3946c627ab7f16ac5304cea7d20c5/src.ts/hash/solidity.ts#L139)

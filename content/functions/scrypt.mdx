...
| `progress`? | [`ProgressCallback`](/content/type-aliases/ProgressCallback) | A callback to update the progress. |
...
[src/crypto/scrypt.ts:90](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/crypto/scrypt.ts#L90)

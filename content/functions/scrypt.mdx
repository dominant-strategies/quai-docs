...
| :------ | :------ | :------ |
| `_passwd` | [`BytesLike`](/content/type-aliases/BytesLike.mdx) | The password to use. |
| `_salt` | [`BytesLike`](/content/type-aliases/BytesLike.mdx) | The salt to use. |
...
| `progress`? | [`ProgressCallback`](/content/type-aliases/ProgressCallback.mdx) | A callback to update the progress. |
...
[src.ts/crypto/scrypt.ts:80](https://github.com/dominant-strategies/quais-6.js/blob/3f482dd134064d41657ff7dc9ba8162f741c9c83/src.ts/crypto/scrypt.ts#L80)

...
[quais6](../globals.md) / scrypt

# Function: scrypt()

> **scrypt**(`_passwd`, `_salt`, `N`, `r`, `p`, `dkLen`, `progress`?): `Promise`\<`string`\>
...
• **\_passwd**: [`BytesLike`](../type-aliases/BytesLike.md)
...
[src.ts/crypto/scrypt.ts:80](https://github.com/dominant-strategies/quais-6.js/blob/aca1855329c3946c627ab7f16ac5304cea7d20c5/src.ts/crypto/scrypt.ts#L80)

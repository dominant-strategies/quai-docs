...
A **ContractTransactionResponse** will return a [**ContractTransactionReceipt**](/content/classes/ContractTransactionReceipt)
when waited on.
...
| :------ | :------ | :------ | :------ | :------ |
| `accessList` | `readonly` | `null` \| [`AccessList`](/content/type-aliases/AccessList) | The [EIP-2930](https://eips.ethereum.org/EIPS/eip-2930) access list for transaction types that support it,<br />otherwise `null`. | `QuaiTransactionResponse.accessList` |
...
| `from` | `readonly` | `string` | The sender of this transaction. It is implicitly computed from the transaction pre-image hash (as the digest) and<br />the [**signature** ](/content/classes/ContractTransactionResponse) using ecrecover. | `QuaiTransactionResponse.from` |
...
[src/providers/provider.ts:1659](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1659)
...
[src/providers/provider.ts:1620](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1620)
...
[src/providers/provider.ts:1644](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1644)
...
[src/providers/provider.ts:1918](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1918)
...
[src/providers/provider.ts:1927](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1927)
...
| Parameter | Type | Description |
| :------ | :------ | :------ |
| `other`? | [`TransactionResponse`](/content/type-aliases/TransactionResponse) | The other transaction to compare against. |
...
[src/providers/provider.ts:1941](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1941)
...
[src/providers/provider.ts:1964](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1964)
...
[src/providers/provider.ts:1586](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/providers/provider.ts#L1586)
...
`Promise`\<`null` \| [`ContractTransactionReceipt`](/content/classes/ContractTransactionReceipt)\>
...
[src/contract/wrappers.ts:141](https://github.com/dominant-strategies/quais-6.js/blob/95934f9b18ff90a0666dd9772179b612f2ad5510/src/contract/wrappers.ts#L141)

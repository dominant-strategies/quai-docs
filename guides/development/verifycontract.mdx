...
This guide follows the [Deploy with Solidity](https://docs.qu.ai/guides/development/solidity) guide so make sure you're familiar with that and the hardhat-example repo before beginning.
...
Metadata JSON for ERC20 saved to /home/mpoletiek/Devspace/dominant-strategies/hardhat-example/Solidity/metadata/ERC20_metadata.json
...
Run the following command using **your** IPFS hash to download the metadata and save it as `ipfsMeta.json`.

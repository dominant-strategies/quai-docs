...
<Tip>
	If you've already cloned the `hardhat-example` repository for the [Single-Chain Deployment Tutorial](/guides/development/solidity), you can
	skip the cloning step. Just navigate to the `SolidityX` directory and run `npm install`.
</Tip>
...
<Note>
	...
	Standard](https://github.com/dominant-strategies/SolidityX-Contracts/blob/main/QRC20X.sol).
</Note>

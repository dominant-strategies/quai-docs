...
Once both services are running, you'll need to start your Quai Network node. For information on how to start up your node, refer to the [Run a Node](/participate/node/run-a-node) guide.

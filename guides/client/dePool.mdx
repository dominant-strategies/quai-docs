...
|                                                   |                                                   |
| ------------------------------------------------- | ------------------------------------------------- |
| [Quai Network Node](/participate/node/run-a-node) | A Quai Network node to use as the pool endpoint.  |
...
```bash
git switch decentralized-mining-pool
```
...
<Tabs>
  <Tab title="Start command flags">
    ```bash
    --workshares.pool true --rpc.http-api "quai,net,workshares" --rpc.ws-api "quai,net,workshares" --rpc.ws-addr "0.0.0.0" --rpc.ws-origins "*"
    ```
  </Tab>

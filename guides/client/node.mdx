...
<Note>
	...
	majority of users. If you're split on which kind of node to run, [read this](/participate/node/node-faq.md#global-v-slice-node).
</Note>
...
<Warning>
	...
	Quai Network is operating at high/maximum load, visit the [Node Overview page](/participate/node/node-overview.md#node-types) or the [Node
	FAQ](/participate/node/node-faq.md#node-hardware-specs).
</Warning>
...
![Latency Map](/images/LatencyMap.jpg)

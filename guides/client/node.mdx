...
<AccordionGroup >
  ...
  <Accordion title="Port fowarding" icon="folder-check">
   If your miner and node are not on the same network you may need to port forward for port 3333. If they are on the same network, no port forwarding is needed.

...
<Warning>
	You only need to run this command once the first time you run go-quai. Once the config file has been created, you do not need to run the
	configuration command again.
</Warning>

This will create and populate a go-quai specific `config.toml` file in a directory at the root of your machine.

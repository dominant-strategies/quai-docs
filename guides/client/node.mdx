...
```bash
./build/bin/go-quai start --node.slices '[0 0]' --node.genesis-nonce 6224362036655375007 --node.quai-coinbases '0x0000000000000000000000000000000000000000' --node.qi-coinbases '0x0080000000000000000000000000000000000000' --node.miner-preference '0.5'
```

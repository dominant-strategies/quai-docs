...
| Chain Name | Type   | Chain Index | Web Socket Port | Stratum Run Flags                |
| ---------- | ------ | ----------- | --------------- | -------------------------------- |
| Cyprus     | Region |             | 8002            | `--region=cyprus`                |
| Paxos      | Region |             | 8003            | `--region=paxos`                 |
| Hydra      | Region |             | 8004            | `--region=hydra`                 |
| Cyprus1    | Zone   | [0 0]       | 8200            | `--region=cyprus --zone=cyprus1` |
| Cyprus2    | Zone   | [0 1]       | 8201            | `--region=cyprus --zone=cyprus2` |
| Cyprus3    | Zone   | [0 2]       | 8202            | `--region=cyprus --zone=cyprus3` |
| Paxos1     | Zone   | [1 0]       | 8220            | `--region=paxos --zone=paxos1`   |
| Paxos2     | Zone   | [1 1]       | 8221            | `--region=paxos --zone=paxos2`   |
| Paxos3     | Zone   | [1 2]       | 8222            | `--region=paxos --zone=paxos3`   |
| Hydra1     | Zone   | [2 0]       | 8240            | `--region=hydra --zone=hydra1`   |
| Hydra2     | Zone   | [2 1]       | 8241            | `--region=hydra --zone=hydra2`   |
| Hydra3     | Zone   | [2 2]       | 8242            | `--region=hydra --zone=hydra3`   |

<Warning>
	**Do not open the above web socket ports except** in the specific case where your miner is on a different network than your node/stratum
	(and even then, be sure to only open the port to the necessary machine). You may be putting your local network security at risk.
</Warning>

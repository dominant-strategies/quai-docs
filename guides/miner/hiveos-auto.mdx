...
<Warning>
	You must have an instance of the [Quai Stratum Proxy](/participate/stratum-proxy/run-stratum) running before you can run a GPU miner.
</Warning>
...
- [Low hash rate on AMD cards](/participate/mining/gpu-miner/gpu-miner-faq#amd-low-hash-rate)
...
<Note>
	...
	or need specific drivers, you may prefer the customization of [the non-script
	installation](/participate/mining/gpu-miner/hive-manual/hive-manual).
</Note>

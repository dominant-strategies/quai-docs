...
<Warning>You must have an instance of the [quai stratum proxy](/guides/client/stratum) before running a GPU miner.</Warning>
...
<Note>
	...
	script](/guides/mining/hiveos-auto). The manual installation is only recommended for users needing more customization
...
<Warning>
	Do not start the miner before confirming your node has fully synced. Mining while your

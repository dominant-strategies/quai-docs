...
<Steps>
  ...
  <Step title="Add Flight Sheet">
    ...
    - For the **Extra config arguments**, use `-U --HWMON 1 -P stratum://EXTERNALIPADDRESS:PORT` for NVIDIA cards (Change -U to -G for AMD cards).

    On bottom right corner, click "Apply Changes".

    <Frame>
      <img src='/images/FlightSheet/FS5.jpg' />
    </Frame>

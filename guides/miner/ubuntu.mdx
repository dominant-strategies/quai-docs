...
<Warning>If your miner and proxy are not on the same machine, you may need to port forward the proxy port.</Warning>
...
## Other Miner Operations

<AccordionGroup >
</Accordion>
  <Accordion title="Removing a miner" icon="power-off">
   
    To remove the miner, delete the output folder that contains quai-gpu-miner. 
